...
import * as $$$$0 from "./routes/live/editorData.ts";
...
import * as $$$$6 from "./routes/live/release.ts";
import * as $$$$7 from "./routes/live/workbench.ts";
import * as $$$$8 from "./routes/live/workflows/run.ts";
...
const manifest = {
  ...
  "routes": {
    ...
    "./routes/live/release.ts": $$$$6,
    "./routes/live/workbench.ts": $$$$7,
    "./routes/live/workflows/run.ts": $$$$8,
  },
  "handlers": {
