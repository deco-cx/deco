...
export declare type SchemaValue<T, TProperty extends string> = T | Role<T, TProperty> | readonly (T | Role<T, TProperty>)[];
...
export interface EmployeeRoleBase extends OrganizationRoleBase {
...
export declare type EmployeeRoleLeaf<TContent, TProperty extends string> = EmployeeRoleBase & {
  "@type": "EmployeeRole";
} & {
...
export interface LinkRoleBase extends RoleBase {
...
export declare type LinkRoleLeaf<TContent, TProperty extends string> = LinkRoleBase & {
  "@type": "LinkRole";
} & {
  [key in TProperty]: TContent;
};
...
export interface OrganizationRoleBase extends RoleBase {
  /** A number associated with a role in an organization, for example, the number on an athlete's jersey. */
  "numberedPosition"?: SchemaValue<Number, "numberedPosition">;
}
export declare type OrganizationRoleLeaf<TContent, TProperty extends string> = OrganizationRoleBase & {
...
export interface PerformanceRoleBase extends RoleBase {
  /** The name of a character played in some acting or performing role, i.e. in a PerformanceRole. */
  "characterName"?: SchemaValue<Text, "characterName">;
}
export declare type PerformanceRoleLeaf<TContent, TProperty extends string> = PerformanceRoleBase & {
...
export interface RoleBase extends ThingBase {
...
export declare type RoleLeaf<TContent, TProperty extends string> = RoleBase & {
  "@type": "Role";
} & {
  [key in TProperty]: TContent;
};
...
export interface _3DModelBase extends MediaObjectBase {
  /** Whether the 3DModel allows resizing. For example, room layout applications often do not allow 3DModel elements to be resized to reflect reality. */
  "isResizable"?: SchemaValue<Boolean, "isResizable">;
}
export interface _3DModelLeaf extends _3DModelBase {
  "@type": "3DModel";
}
...
export interface AboutPageLeaf extends WebPageBase {
  "@type": "AboutPage";
}
/** Web page type: About page. */
export declare type AboutPage = AboutPageLeaf;
export interface AcceptActionLeaf extends ActionBase {
  "@type": "AcceptAction";
}
/**
...
export interface AccommodationBase extends PlaceBase {
...
export interface AccommodationLeaf extends AccommodationBase {
  "@type": "Accommodation";
}
/**
...
export interface AccountingServiceLeaf extends FinancialServiceBase {
...
export interface ActionLeaf extends ActionBase {
  "@type": "Action";
}
/**
...
export interface ActionAccessSpecificationBase extends ThingBase {
...
export interface ActionAccessSpecificationLeaf extends ActionAccessSpecificationBase {
  "@type": "ActionAccessSpecification";
}
/** A set of requirements that a must be fulfilled in order to perform an Action. */
export declare type ActionAccessSpecification = ActionAccessSpecificationLeaf;
export interface ActionStatusTypeLeaf extends EnumerationBase {
...
export interface ActivateActionLeaf extends ActionBase {
  "@type": "ActivateAction";
}
/** The act of starting or activating a device or application (e.g. starting a timer or turning on a flashlight). */
export declare type ActivateAction = ActivateActionLeaf;
export interface AddActionLeaf extends UpdateActionBase {
  "@type": "AddAction";
}
/** The act of editing by adding an object to a collection. */
export declare type AddAction = AddActionLeaf | InsertAction;
export interface AdministrativeAreaLeaf extends PlaceBase {
...
export interface AdultEntertainmentLeaf extends LocalBusinessBase {
  "@type": "AdultEntertainment";
}
/** An adult entertainment establishment. */
export declare type AdultEntertainment = AdultEntertainmentLeaf | string;
export interface AdvertiserContentArticleLeaf extends ArticleBase {
...
export interface AggregateOfferBase extends OfferBase {
  /**
...
export interface AggregateOfferLeaf extends AggregateOfferBase {
  "@type": "AggregateOffer";
}
/**
...
export interface AggregateRatingBase extends RatingBase {
...
export interface AirlineLeaf extends AirlineBase {
  "@type": "Airline";
}
/** An organization that provides flights for passengers. */
export declare type Airline = AirlineLeaf | string;
export interface AirportBase extends CivicStructureBase {
  /** IATA identifier for an airline or airport. */
  "iataCode"?: SchemaValue<Text, "iataCode">;
  /** ICAO identifier for an airport. */
  "icaoCode"?: SchemaValue<Text, "icaoCode">;
}
export interface AirportLeaf extends AirportBase {
  "@type": "Airport";
}
/** An airport. */
export declare type Airport = AirportLeaf | string;
export interface AlignmentObjectBase extends ThingBase {
...
export interface AlignmentObjectLeaf extends AlignmentObjectBase {
...
export interface AllocateActionLeaf extends ActionBase {
  "@type": "AllocateAction";
}
...
export interface AmpStoryLeaf extends CreativeWorkBase {
  "@type": "AmpStory";
}
/** A creative work with a visual storytelling format intended to be viewed online, particularly on mobile devices. */
export declare type AmpStory = AmpStoryLeaf;
export interface AMRadioChannelLeaf extends BroadcastChannelBase {
  "@type": "AMRadioChannel";
}
/** A radio channel that uses AM. */
export declare type AMRadioChannel = AMRadioChannelLeaf;
export interface AmusementParkLeaf extends LocalBusinessBase {
  "@type": "AmusementPark";
}
/** An amusement park. */
export declare type AmusementPark = AmusementParkLeaf | string;
export interface AnalysisNewsArticleLeaf extends NewsArticleBase {
...
export interface AnatomicalStructureBase extends MedicalEntityBase {
...
export interface AnatomicalStructureLeaf extends AnatomicalStructureBase {
...
export interface AnatomicalSystemBase extends MedicalEntityBase {
  /** If applicable, a description of the pathophysiology associated with the anatomical system, including potential abnormal changes in the mechanical, physical, and biochemical functions of the system. */
  "associatedPathophysiology"?: SchemaValue<Text, "associatedPathophysiology">;
...
export interface AnatomicalSystemLeaf extends AnatomicalSystemBase {
...
export interface ApartmentLeaf extends ApartmentBase {
  "@type": "Apartment";
}
...
export interface ApartmentComplexBase extends ResidenceBase {
...
export interface ApartmentComplexLeaf extends ApartmentComplexBase {
  "@type": "ApartmentComplex";
}
/** Residence type: Apartment complex. */
export declare type ApartmentComplex = ApartmentComplexLeaf | string;
export interface APIReferenceBase extends TechArticleBase {
  /**
...
export interface APIReferenceLeaf extends APIReferenceBase {
  "@type": "APIReference";
}
/** Reference documentation for application programming export interfaces (APIs). */
export declare type APIReference = APIReferenceLeaf;
export interface AppendActionLeaf extends InsertActionBase {
  "@type": "AppendAction";
}
/** The act of inserting at the end if an ordered collection. */
export declare type AppendAction = AppendActionLeaf;
export interface ApplyActionLeaf extends ActionBase {
  "@type": "ApplyAction";
}
/**
...
export interface ApprovedIndicationLeaf extends MedicalEntityBase {
...
export interface AquariumLeaf extends CivicStructureBase {
  "@type": "Aquarium";
}
/** Aquarium. */
export declare type Aquarium = AquariumLeaf | string;
export interface ArchiveComponentBase extends CreativeWorkBase {
...
export interface ArchiveComponentLeaf extends ArchiveComponentBase {
  "@type": "ArchiveComponent";
}
/** An intangible type to be applied to any archive content, carrying with it a set of properties required to describe archival items and collections. */
export declare type ArchiveComponent = ArchiveComponentLeaf;
export interface ArchiveOrganizationBase extends LocalBusinessBase {
...
export interface ArchiveOrganizationLeaf extends ArchiveOrganizationBase {
  "@type": "ArchiveOrganization";
}
/** An organization with archival holdings. An organization which keeps and preserves archival material and typically makes it accessible to the public. */
export declare type ArchiveOrganization = ArchiveOrganizationLeaf | string;
export interface ArriveActionLeaf extends MoveActionBase {
  "@type": "ArriveAction";
}
/** The act of arriving at a place. An agent arrives at a destination from a fromLocation, optionally with participants. */
export declare type ArriveAction = ArriveActionLeaf;
export interface ArteryBase extends AnatomicalStructureBase {
...
export interface ArteryLeaf extends ArteryBase {
  "@type": "Artery";
}
/** A type of blood vessel that specifically carries blood away from the heart. */
export declare type Artery = ArteryLeaf;
export interface ArtGalleryLeaf extends LocalBusinessBase {
  "@type": "ArtGallery";
}
/** An art gallery. */
export declare type ArtGallery = ArtGalleryLeaf | string;
export interface ArticleBase extends CreativeWorkBase {
...
export interface ArticleLeaf extends ArticleBase {
  "@type": "Article";
}
/**
...
export interface AskActionBase extends CommunicateActionBase {
  /** A sub property of object. A question. */
  "question"?: SchemaValue<Question | IdReference, "question">;
}
export interface AskActionLeaf extends AskActionBase {
  "@type": "AskAction";
}
/**
...
export interface AskPublicNewsArticleLeaf extends NewsArticleBase {
...
export interface AudienceBase extends ThingBase {
...
export interface AudienceLeaf extends AudienceBase {
  "@type": "Audience";
}
...
export interface AudiobookBase extends BookBase, AudioObjectBase {
...
export interface AudiobookLeaf extends AudiobookBase {
  "@type": "Audiobook";
}
/** An audiobook. */
export declare type Audiobook = AudiobookLeaf;
export interface AudioObjectBase extends MediaObjectBase {
...
export interface AudioObjectLeaf extends AudioObjectBase {
  "@type": "AudioObject";
}
/** An audio file. */
export declare type AudioObject = AudioObjectLeaf | Audiobook | AudioObjectSnapshot;
export interface AudioObjectSnapshotLeaf extends AudioObjectBase {
...
export interface AuthorizeActionBase extends ActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface AuthorizeActionLeaf extends AuthorizeActionBase {
  "@type": "AuthorizeAction";
}
/** The act of granting permission to an object. */
export declare type AuthorizeAction = AuthorizeActionLeaf;
export interface AutoBodyShopLeaf extends LocalBusinessBase {
  "@type": "AutoBodyShop";
}
/** Auto body shop. */
export declare type AutoBodyShop = AutoBodyShopLeaf | string;
export interface AutoDealerLeaf extends LocalBusinessBase {
  "@type": "AutoDealer";
}
/** An car dealership. */
export declare type AutoDealer = AutoDealerLeaf | string;
export interface AutomatedTellerLeaf extends FinancialServiceBase {
  "@type": "AutomatedTeller";
}
/** ATM/cash machine. */
export declare type AutomatedTeller = AutomatedTellerLeaf | string;
export interface AutomotiveBusinessLeaf extends LocalBusinessBase {
...
export interface AutoPartsStoreBase extends LocalBusinessBase, LocalBusinessBase {
}
export interface AutoPartsStoreLeaf extends AutoPartsStoreBase {
  "@type": "AutoPartsStore";
}
/** An auto parts store. */
export declare type AutoPartsStore = AutoPartsStoreLeaf | string;
export interface AutoRentalLeaf extends LocalBusinessBase {
  "@type": "AutoRental";
}
/** A car rental business. */
export declare type AutoRental = AutoRentalLeaf | string;
export interface AutoRepairLeaf extends LocalBusinessBase {
  "@type": "AutoRepair";
}
/** Car repair business. */
export declare type AutoRepair = AutoRepairLeaf | string;
export interface AutoWashLeaf extends LocalBusinessBase {
  "@type": "AutoWash";
}
/** A car wash business. */
export declare type AutoWash = AutoWashLeaf | string;
export interface BackgroundNewsArticleLeaf extends NewsArticleBase {
...
export interface BakeryLeaf extends FoodEstablishmentBase {
  "@type": "Bakery";
}
/** A bakery. */
export declare type Bakery = BakeryLeaf | string;
export interface BankAccountBase extends FinancialProductBase {
...
export interface BankAccountLeaf extends BankAccountBase {
  "@type": "BankAccount";
}
/** A product or service offered by a bank whereby one may deposit, withdraw or transfer money and in some cases be paid interest. */
export declare type BankAccount = BankAccountLeaf | DepositAccount;
export interface BankOrCreditUnionLeaf extends FinancialServiceBase {
  "@type": "BankOrCreditUnion";
}
/** Bank or credit union. */
export declare type BankOrCreditUnion = BankOrCreditUnionLeaf | string;
export interface BarcodeLeaf extends ImageObjectBase {
  "@type": "Barcode";
}
/** An image of a visual machine-readable code such as a barcode or QR code. */
export declare type Barcode = BarcodeLeaf;
export interface BarOrPubLeaf extends FoodEstablishmentBase {
  "@type": "BarOrPub";
}
/** A bar or pub. */
export declare type BarOrPub = BarOrPubLeaf | string;
export interface BeachLeaf extends CivicStructureBase {
  "@type": "Beach";
}
/** Beach. */
export declare type Beach = BeachLeaf | string;
export interface BeautySalonLeaf extends LocalBusinessBase {
  "@type": "BeautySalon";
}
/** Beauty salon. */
export declare type BeautySalon = BeautySalonLeaf | string;
export interface BedAndBreakfastLeaf extends LodgingBusinessBase {
...
export interface BedDetailsBase extends ThingBase {
...
export interface BedDetailsLeaf extends BedDetailsBase {
  "@type": "BedDetails";
}
...
export interface BedTypeLeaf extends QualitativeValueBase {
  "@type": "BedType";
}
/** A type of bed. This is used for indicating the bed or beds available in an accommodation. */
export declare type BedType = BedTypeLeaf;
export interface BefriendActionLeaf extends ActionBase {
  "@type": "BefriendAction";
}
/**
...
export interface BikeStoreLeaf extends LocalBusinessBase {
  "@type": "BikeStore";
}
/** A bike store. */
export declare type BikeStore = BikeStoreLeaf | string;
export interface BioChemEntityBase extends ThingBase {
...
export interface BlogLeaf extends BlogBase {
  "@type": "Blog";
}
...
export interface BlogPostingLeaf extends SocialMediaPostingBase {
  "@type": "BlogPosting";
}
/** A blog post. */
export declare type BlogPosting = BlogPostingLeaf | LiveBlogPosting;
export interface BloodTestLeaf extends MedicalTestBase {
  "@type": "BloodTest";
}
/** A medical test performed on a sample of a patient's blood. */
export declare type BloodTest = BloodTestLeaf;
export interface BoardingPolicyTypeLeaf extends EnumerationBase {
...
export interface BoatReservationLeaf extends ReservationBase {
...
export interface BoatTerminalLeaf extends CivicStructureBase {
  "@type": "BoatTerminal";
}
/** A terminal for boats, ships, and other water vessels. */
export declare type BoatTerminal = BoatTerminalLeaf | string;
export interface BoatTripBase extends TripBase {
...
export interface BoatTripLeaf extends BoatTripBase {
  "@type": "BoatTrip";
}
/** A trip on a commercial ferry line. */
export declare type BoatTrip = BoatTripLeaf;
export interface BodyMeasurementTypeEnumerationLeaf extends EnumerationBase {
...
export interface BodyOfWaterLeaf extends PlaceBase {
  "@type": "BodyOfWater";
}
...
export interface BoneLeaf extends AnatomicalStructureBase {
  "@type": "Bone";
}
/** Rigid connective tissue that comprises up the skeletal structure of the human body. */
export declare type Bone = BoneLeaf;
export interface BookBase extends CreativeWorkBase {
...
export interface BookLeaf extends BookBase {
  "@type": "Book";
}
/** A book. */
export declare type Book = BookLeaf | Audiobook;
export interface BookFormatTypeLeaf extends EnumerationBase {
  "@type": "BookFormatType";
}
...
export interface BookmarkActionLeaf extends ActionBase {
  "@type": "BookmarkAction";
}
/** An agent bookmarks/flags/labels/tags/marks an object. */
export declare type BookmarkAction = BookmarkActionLeaf;
export interface BookSeriesLeaf extends CreativeWorkSeriesBase {
  "@type": "BookSeries";
}
/** A series of books. Included books can be indicated with the hasPart property. */
export declare type BookSeries = BookSeriesLeaf;
export interface BookStoreLeaf extends LocalBusinessBase {
  "@type": "BookStore";
}
/** A bookstore. */
export declare type BookStore = BookStoreLeaf | string;
export interface BorrowActionBase extends TransferActionBase {
  /** A sub property of participant. The person that lends the object being borrowed. */
  "lender"?: SchemaValue<Organization | Person | IdReference, "lender">;
}
export interface BorrowActionLeaf extends BorrowActionBase {
  "@type": "BorrowAction";
}
/**
...
export interface BowlingAlleyLeaf extends LocalBusinessBase {
  "@type": "BowlingAlley";
}
/** A bowling alley. */
export declare type BowlingAlley = BowlingAlleyLeaf | string;
export interface BrainStructureLeaf extends AnatomicalStructureBase {
  "@type": "BrainStructure";
}
/** Any anatomical structure which pertains to the soft nervous tissue functioning as the coordinating center of sensation and intellectual and nervous activity. */
export declare type BrainStructure = BrainStructureLeaf;
export interface BrandBase extends ThingBase {
...
export interface BrandLeaf extends BrandBase {
  "@type": "Brand";
}
/** A brand is a name used by an organization or business person for labeling a product, product group, or similar. */
export declare type Brand = BrandLeaf;
export interface BreadcrumbListLeaf extends ItemListBase {
  "@type": "BreadcrumbList";
}
/**
...
export interface BreweryLeaf extends FoodEstablishmentBase {
  "@type": "Brewery";
}
/** Brewery. */
export declare type Brewery = BreweryLeaf | string;
export interface BridgeLeaf extends CivicStructureBase {
  "@type": "Bridge";
}
/** A bridge. */
export declare type Bridge = BridgeLeaf | string;
export interface BroadcastChannelBase extends ThingBase {
...
export interface BroadcastChannelLeaf extends BroadcastChannelBase {
  "@type": "BroadcastChannel";
}
/** A unique instance of a BroadcastService on a CableOrSatelliteService lineup. */
export declare type BroadcastChannel = BroadcastChannelLeaf | RadioChannel | TelevisionChannel;
export interface BroadcastEventBase extends PublicationEventBase {
...
export interface BroadcastEventLeaf extends BroadcastEventBase {
  "@type": "BroadcastEvent";
}
/** An over the air or online broadcast event. */
export declare type BroadcastEvent = BroadcastEventLeaf;
export interface BroadcastFrequencySpecificationBase extends ThingBase {
...
export interface BroadcastFrequencySpecificationLeaf extends BroadcastFrequencySpecificationBase {
  "@type": "BroadcastFrequencySpecification";
}
/** The frequency in MHz and the modulation used for a particular BroadcastService. */
export declare type BroadcastFrequencySpecification = BroadcastFrequencySpecificationLeaf;
export interface BroadcastServiceBase extends ServiceBase {
  /**
...
export interface BroadcastServiceLeaf extends BroadcastServiceBase {
  "@type": "BroadcastService";
}
/** A delivery service through which content is provided via broadcast over the air or online. */
export declare type BroadcastService = BroadcastServiceLeaf | RadioBroadcastService;
export interface BrokerageAccountLeaf extends InvestmentOrDepositBase {
  "@type": "BrokerageAccount";
}
/** An account that allows an investor to deposit funds and place investment orders with a licensed broker or brokerage firm. */
export declare type BrokerageAccount = BrokerageAccountLeaf;
export interface BuddhistTempleLeaf extends CivicStructureBase {
  "@type": "BuddhistTemple";
}
/** A Buddhist temple. */
export declare type BuddhistTemple = BuddhistTempleLeaf | string;
export interface BusinessAudienceBase extends AudienceBase {
...
export interface BusinessAudienceLeaf extends BusinessAudienceBase {
  "@type": "BusinessAudience";
}
/** A set of characteristics belonging to businesses, e.g. who compose an item's target audience. */
export declare type BusinessAudience = BusinessAudienceLeaf;
export interface BusinessEntityTypeLeaf extends EnumerationBase {
...
export interface BusinessEventLeaf extends EventBase {
  "@type": "BusinessEvent";
}
/** Event type: Business event. */
export declare type BusinessEvent = BusinessEventLeaf;
export interface BusinessFunctionLeaf extends EnumerationBase {
...
export interface BusOrCoachBase extends VehicleBase {
...
export interface BusOrCoachLeaf extends BusOrCoachBase {
  "@type": "BusOrCoach";
}
/** A bus (also omnibus or autobus) is a road vehicle designed to carry passengers. Coaches are luxury busses, usually in service for long distance travel. */
export declare type BusOrCoach = BusOrCoachLeaf;
export interface BusReservationLeaf extends ReservationBase {
  "@type": "BusReservation";
}
/**
...
export interface BusStationLeaf extends CivicStructureBase {
  "@type": "BusStation";
}
/** A bus station. */
export declare type BusStation = BusStationLeaf | string;
export interface BusStopLeaf extends CivicStructureBase {
  "@type": "BusStop";
}
/** A bus stop. */
export declare type BusStop = BusStopLeaf | string;
export interface BusTripBase extends TripBase {
...
export interface BusTripLeaf extends BusTripBase {
  "@type": "BusTrip";
}
/** A trip on a commercial bus line. */
export declare type BusTrip = BusTripLeaf;
export interface BuyActionBase extends TradeActionBase {
...
export interface BuyActionLeaf extends BuyActionBase {
  "@type": "BuyAction";
}
/** The act of giving money to a seller in exchange for goods or services rendered. An agent buys an object, product, or service from a seller for a price. Reciprocal of SellAction. */
export declare type BuyAction = BuyActionLeaf;
export interface CableOrSatelliteServiceLeaf extends ServiceBase {
  "@type": "CableOrSatelliteService";
}
/** A service which provides access to media programming like TV or radio. Access may be via cable or satellite. */
export declare type CableOrSatelliteService = CableOrSatelliteServiceLeaf;
export interface CafeOrCoffeeShopLeaf extends FoodEstablishmentBase {
  "@type": "CafeOrCoffeeShop";
}
/** A cafe or coffee shop. */
export declare type CafeOrCoffeeShop = CafeOrCoffeeShopLeaf | string;
export interface CampgroundBase extends CivicStructureBase, LodgingBusinessBase {
}
export interface CampgroundLeaf extends CampgroundBase {
  "@type": "Campground";
}
/**
...
export interface CampingPitchLeaf extends AccommodationBase {
  "@type": "CampingPitch";
}
/**
...
export interface CanalLeaf extends PlaceBase {
  "@type": "Canal";
}
/** A canal, like the Panama Canal. */
export declare type Canal = CanalLeaf | string;
export interface CancelActionLeaf extends PlanActionBase {
  "@type": "CancelAction";
}
/**
...
export interface CarBase extends VehicleBase {
  /** The ACRISS Car Classification Code is a code used by many car rental companies, for classifying vehicles. ACRISS stands for Association of Car Rental Industry Systems and Standards. */
  "acrissCode"?: SchemaValue<Text, "acrissCode">;
  /**
   * The permitted total weight of cargo and installations (e.g. a roof rack) on top of the vehicle.
...
export interface CarUsageTypeLeaf extends EnumerationBase {
  "@type": "CarUsageType";
}
...
export interface CasinoLeaf extends LocalBusinessBase {
  "@type": "Casino";
}
/** A casino. */
export declare type Casino = CasinoLeaf | string;
export interface CategoryCodeBase extends DefinedTermBase {
...
export interface CategoryCodeLeaf extends CategoryCodeBase {
  "@type": "CategoryCode";
}
/** A Category Code. */
export declare type CategoryCode = CategoryCodeLeaf | MedicalCode;
export interface CategoryCodeSetBase extends DefinedTermSetBase {
  /** A Category code contained in this code set. */
  "hasCategoryCode"?: SchemaValue<CategoryCode | IdReference, "hasCategoryCode">;
}
export interface CategoryCodeSetLeaf extends CategoryCodeSetBase {
  "@type": "CategoryCodeSet";
}
/** A set of Category Code values. */
export declare type CategoryCodeSet = CategoryCodeSetLeaf;
export interface CatholicChurchLeaf extends CivicStructureBase {
  "@type": "CatholicChurch";
}
/** A Catholic church. */
export declare type CatholicChurch = CatholicChurchLeaf | string;
export interface CDCPMDRecordBase extends ThingBase {
...
export interface CDCPMDRecordLeaf extends CDCPMDRecordBase {
  "@type": "CDCPMDRecord";
}
...
export interface CemeteryLeaf extends CivicStructureBase {
  "@type": "Cemetery";
}
/** A graveyard. */
export declare type Cemetery = CemeteryLeaf | string;
export interface ChapterBase extends CreativeWorkBase {
  /** The page on which the work ends; for example "138" or "xvi". */
  "pageEnd"?: SchemaValue<Integer | Text, "pageEnd">;
  /** The page on which the work starts; for example "135" or "xiii". */
  "pageStart"?: SchemaValue<Integer | Text, "pageStart">;
...
export interface ChapterLeaf extends ChapterBase {
  "@type": "Chapter";
}
/** One of the sections into which a book is divided. A chapter usually has a section number or a name. */
export declare type Chapter = ChapterLeaf;
export interface CheckActionLeaf extends ActionBase {
  "@type": "CheckAction";
}
/** An agent inspects, determines, investigates, inquires, or examines an object's accuracy, quality, condition, or state. */
export declare type CheckAction = CheckActionLeaf;
export interface CheckInActionLeaf extends CommunicateActionBase {
  "@type": "CheckInAction";
}
/**
...
export interface CheckOutActionLeaf extends CommunicateActionBase {
  "@type": "CheckOutAction";
}
/**
...
export interface CheckoutPageLeaf extends WebPageBase {
  "@type": "CheckoutPage";
}
/** Web page type: Checkout page. */
export declare type CheckoutPage = CheckoutPageLeaf;
export interface ChemicalSubstanceBase extends BioChemEntityBase {
...
export interface ChemicalSubstanceLeaf extends ChemicalSubstanceBase {
...
export interface ChildCareLeaf extends LocalBusinessBase {
  "@type": "ChildCare";
}
/** A Childcare center. */
export declare type ChildCare = ChildCareLeaf | string;
export interface ChildrensEventLeaf extends EventBase {
  "@type": "ChildrensEvent";
}
/** Event type: Children's event. */
export declare type ChildrensEvent = ChildrensEventLeaf;
export interface ChooseActionBase extends ActionBase {
...
export interface ChooseActionLeaf extends ChooseActionBase {
  "@type": "ChooseAction";
}
/** The act of expressing a preference from a set of options or a large or unbounded set of choices/options. */
export declare type ChooseAction = ChooseActionLeaf | VoteAction;
export interface ChurchLeaf extends CivicStructureBase {
  "@type": "Church";
}
/** A church. */
export declare type Church = ChurchLeaf | CatholicChurch | string;
export interface CityLeaf extends PlaceBase {
  "@type": "City";
}
/** A city or town. */
export declare type City = CityLeaf | string;
export interface CityHallLeaf extends CivicStructureBase {
  "@type": "CityHall";
}
/** A city hall. */
export declare type CityHall = CityHallLeaf | string;
export interface CivicStructureBase extends PlaceBase {
  /**
...
export interface CivicStructureLeaf extends CivicStructureBase {
  "@type": "CivicStructure";
}
...
export interface ClaimBase extends CreativeWorkBase {
...
export interface ClaimLeaf extends ClaimBase {
  "@type": "Claim";
}
/**
...
export interface ClipLeaf extends ClipBase {
  "@type": "Clip";
}
/** A short TV or radio program or a segment/part of a program. */
export declare type Clip = ClipLeaf | MovieClip | RadioClip | TVClip | VideoGameClip;
export interface ClothingStoreLeaf extends LocalBusinessBase {
  "@type": "ClothingStore";
}
/** A clothing store. */
export declare type ClothingStore = ClothingStoreLeaf | string;
export interface CodeLeaf extends CreativeWorkBase {
  "@type": "Code";
}
/**
...
export interface CollectionBase extends CreativeWorkBase {
  /** The number of items in the {@link https://schema.org/Collection Collection}. */
  "collectionSize"?: SchemaValue<Integer, "collectionSize">;
}
export interface CollectionLeaf extends CollectionBase {
  "@type": "Collection";
}
/** A collection of items e.g. creative works or products. */
export declare type Collection = CollectionLeaf | ProductCollection;
export interface CollectionPageLeaf extends WebPageBase {
  "@type": "CollectionPage";
}
/** Web page type: Collection page. */
export declare type CollectionPage = CollectionPageLeaf | MediaGallery;
export interface CollegeOrUniversityLeaf extends EducationalOrganizationBase {
  "@type": "CollegeOrUniversity";
}
/** A college, university, or other third-level educational institution. */
export declare type CollegeOrUniversity = CollegeOrUniversityLeaf | string;
export interface ComedyClubLeaf extends LocalBusinessBase {
  "@type": "ComedyClub";
}
/** A comedy club. */
export declare type ComedyClub = ComedyClubLeaf | string;
export interface ComedyEventLeaf extends EventBase {
  "@type": "ComedyEvent";
}
/** Event type: Comedy event. */
export declare type ComedyEvent = ComedyEventLeaf;
export interface ComicCoverArtBase extends VisualArtworkBase, ComicStoryBase {
}
export interface ComicCoverArtLeaf extends ComicCoverArtBase {
  "@type": "ComicCoverArt";
}
/** The artwork on the cover of a comic. */
export declare type ComicCoverArt = ComicCoverArtLeaf;
export interface ComicIssueBase extends PublicationIssueBase {
...
export interface ComicIssueLeaf extends ComicIssueBase {
  "@type": "ComicIssue";
}
...
export interface ComicSeriesLeaf extends CreativeWorkSeriesBase {
  "@type": "ComicSeries";
}
...
export interface ComicStoryBase extends CreativeWorkBase {
  /** The primary artist for a work in a medium other than pencils or digital line art--for example, if the primary artwork is done in watercolors or digital paints. */
  "artist"?: SchemaValue<Person | IdReference, "artist">;
  /** The individual who adds color to inked drawings. */
  "colorist"?: SchemaValue<Person | IdReference, "colorist">;
...
export interface ComicStoryLeaf extends ComicStoryBase {
  "@type": "ComicStory";
}
...
export interface CommentBase extends CreativeWorkBase {
...
export interface CommentLeaf extends CommentBase {
  "@type": "Comment";
}
...
export interface CommentActionBase extends CommunicateActionBase {
  /** A sub property of result. The Comment created or sent as a result of this action. */
  "resultComment"?: SchemaValue<Comment | IdReference, "resultComment">;
}
export interface CommentActionLeaf extends CommentActionBase {
  "@type": "CommentAction";
}
/** The act of generating a comment about a subject. */
export declare type CommentAction = CommentActionLeaf;
export interface CommunicateActionBase extends ActionBase {
...
export interface CommunicateActionLeaf extends CommunicateActionBase {
...
export interface CommunityHealthLeaf extends LocalBusinessBase {
...
export declare type CommunityHealth = CommunityHealthLeaf | string;
export interface CompleteDataFeedLeaf extends DataFeedBase {
...
export interface CompoundPriceSpecificationBase extends PriceSpecificationBase {
...
export interface CompoundPriceSpecificationLeaf extends CompoundPriceSpecificationBase {
...
export interface ComputerLanguageLeaf extends ThingBase {
...
export interface ComputerStoreLeaf extends LocalBusinessBase {
  "@type": "ComputerStore";
}
/** A computer store. */
export declare type ComputerStore = ComputerStoreLeaf | string;
export interface ConfirmActionLeaf extends InformActionBase {
  "@type": "ConfirmAction";
}
/**
...
export interface ConsortiumLeaf extends OrganizationBase {
  "@type": "Consortium";
}
...
export interface ConsumeActionBase extends ActionBase {
...
export interface ConsumeActionLeaf extends ConsumeActionBase {
  "@type": "ConsumeAction";
}
...
export interface ContactPageLeaf extends WebPageBase {
  "@type": "ContactPage";
}
/** Web page type: Contact page. */
export declare type ContactPage = ContactPageLeaf;
export interface ContactPointBase extends ThingBase {
...
export interface ContactPointOptionLeaf extends EnumerationBase {
...
export interface CookActionLeaf extends CookActionBase {
  "@type": "CookAction";
}
/** The act of producing/preparing food. */
export declare type CookAction = CookActionLeaf;
export interface CorporationBase extends OrganizationBase {
  /** The exchange traded instrument associated with a Corporation object. The tickerSymbol is expressed as an exchange and an instrument name separated by a space character. For the exchange component of the tickerSymbol attribute, we recommend using the controlled vocabulary of Market Identifier Codes (MIC) specified in ISO15022. */
  "tickerSymbol"?: SchemaValue<Text, "tickerSymbol">;
}
export interface CorporationLeaf extends CorporationBase {
  "@type": "Corporation";
}
/** Organization: A business corporation. */
export declare type Corporation = CorporationLeaf | string;
export interface CorrectionCommentLeaf extends CommentBase {
...
export interface CountryLeaf extends PlaceBase {
  "@type": "Country";
}
/** A country. */
export declare type Country = CountryLeaf | string;
export interface CourseBase extends CreativeWorkBase, LearningResourceBase {
...
export interface CourseInstanceLeaf extends CourseInstanceBase {
  "@type": "CourseInstance";
}
...
export interface CourthouseLeaf extends CivicStructureBase {
  "@type": "Courthouse";
}
/** A courthouse. */
export declare type Courthouse = CourthouseLeaf | string;
export interface CoverArtLeaf extends VisualArtworkBase {
  "@type": "CoverArt";
}
/** The artwork on the outer surface of a CreativeWork. */
export declare type CoverArt = CoverArtLeaf | ComicCoverArt;
export interface CovidTestingFacilityLeaf extends MedicalClinicBase {
...
export interface CreateActionLeaf extends ActionBase {
  "@type": "CreateAction";
}
...
export interface CreativeWorkBase extends ThingBase {
  ...
  "expires"?: SchemaValue<Date, "expires">;
  /**
...
export interface CreativeWorkLeaf extends CreativeWorkBase {
  "@type": "CreativeWork";
}
...
export interface CreativeWorkSeasonBase extends CreativeWorkBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /** A director of e.g. tv, radio, movie, video gaming etc. content, or of an event. Directors can be associated with individual items or with a series, episode, clip. */
  "director"?: SchemaValue<Person | IdReference, "director">;
...
export interface CreativeWorkSeasonLeaf extends CreativeWorkSeasonBase {
  "@type": "CreativeWorkSeason";
}
/** A media season e.g. tv, radio, video game etc. */
export declare type CreativeWorkSeason = CreativeWorkSeasonLeaf | PodcastSeason | RadioSeason | TVSeason;
export interface CreativeWorkSeriesBase extends CreativeWorkBase, ThingBase {
  /** The end date and time of the item (in {@link http://en.wikipedia.org/wiki/ISO_8601 ISO 8601 date format}). */
  "endDate"?: SchemaValue<Date | DateTime, "endDate">;
  /** The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication. */
  "issn"?: SchemaValue<Text, "issn">;
...
export interface CreativeWorkSeriesLeaf extends CreativeWorkSeriesBase {
...
export interface CreditCardBase extends LoanOrCreditBase, PaymentCardBase {
}
export interface CreditCardLeaf extends CreditCardBase {
  "@type": "CreditCard";
}
/**
...
export interface CrematoriumLeaf extends CivicStructureBase {
  "@type": "Crematorium";
}
/** A crematorium. */
export declare type Crematorium = CrematoriumLeaf | string;
export interface CriticReviewLeaf extends ReviewBase {
  "@type": "CriticReview";
}
...
export interface CurrencyConversionServiceLeaf extends FinancialProductBase {
  "@type": "CurrencyConversionService";
}
/** A service to convert funds from one currency to another currency. */
export declare type CurrencyConversionService = CurrencyConversionServiceLeaf;
export interface DanceEventLeaf extends EventBase {
  "@type": "DanceEvent";
}
/** Event type: A social dance. */
export declare type DanceEvent = DanceEventLeaf;
export interface DanceGroupLeaf extends OrganizationBase {
  "@type": "DanceGroup";
}
/** A dance group—for example, the Alvin Ailey Dance Theater or Riverdance. */
export declare type DanceGroup = DanceGroupLeaf | string;
export interface DataCatalogBase extends CreativeWorkBase {
   ...
   */
  "measurementTechnique"?: SchemaValue<Text | URL, "measurementTechnique">;
}
export interface DataCatalogLeaf extends DataCatalogBase {
  "@type": "DataCatalog";
}
/** A collection of datasets. */
export declare type DataCatalog = DataCatalogLeaf;
export interface DataDownloadBase extends MediaObjectBase {
  /**
   * A technique or technology used in a {@link https://schema.org/Dataset Dataset} (or {@link https://schema.org/DataDownload DataDownload}, {@link https://schema.org/DataCatalog DataCatalog}), corresponding to the method used for measuring the corresponding variable(s) (described using {@link https://schema.org/variableMeasured variableMeasured}). This is oriented towards scientific and scholarly dataset publication but may have broader applicability; it is not intended as a full representation of measurement, but rather as a high level summary for dataset discovery.
   *
   * For example, if {@link https://schema.org/variableMeasured variableMeasured} is: molecule concentration, {@link https://schema.org/measurementTechnique measurementTechnique} could be: "mass spectrometry" or "nmr spectroscopy" or "colorimetry" or "immunofluorescence".
...
export interface DataFeedItemLeaf extends DataFeedItemBase {
  "@type": "DataFeedItem";
}
/** A single item within a larger data feed. */
export declare type DataFeedItem = DataFeedItemLeaf;
export interface DatasetBase extends CreativeWorkBase {
  /**
  ...
  "variableMeasured"?: SchemaValue<PropertyValue | Text | IdReference, "variableMeasured">;
}
export interface DatasetLeaf extends DatasetBase {
  "@type": "Dataset";
}
/** A body of structured information describing some topic(s) of interest. */
export declare type Dataset = DatasetLeaf | DataFeed;
export interface DatedMoneySpecificationBase extends ThingBase {
  /** The amount of money. */
...
export interface DatedMoneySpecificationLeaf extends DatedMoneySpecificationBase {
...
export interface DayOfWeekLeaf extends EnumerationBase {
  "@type": "DayOfWeek";
}
/**
...
export interface DaySpaLeaf extends LocalBusinessBase {
  "@type": "DaySpa";
}
/** A day spa. */
export declare type DaySpa = DaySpaLeaf | string;
export interface DDxElementBase extends MedicalEntityBase {
...
export interface DefinedRegionLeaf extends DefinedRegionBase {
  "@type": "DefinedRegion";
}
/**
...
export interface DefinedTermBase extends ThingBase {
...
export interface DefinedTermLeaf extends DefinedTermBase {
  "@type": "DefinedTerm";
}
...
export interface DefinedTermSetBase extends CreativeWorkBase {
  /** A Defined Term contained in this term set. */
  "hasDefinedTerm"?: SchemaValue<DefinedTerm | IdReference, "hasDefinedTerm">;
}
export interface DefinedTermSetLeaf extends DefinedTermSetBase {
  "@type": "DefinedTermSet";
}
/** A set of defined terms for example a set of categories or a classification scheme, a glossary, dictionary or enumeration. */
export declare type DefinedTermSet = DefinedTermSetLeaf | CategoryCodeSet;
export interface DeleteActionLeaf extends UpdateActionBase {
  "@type": "DeleteAction";
}
/** The act of editing a recipient by removing one of its objects. */
export declare type DeleteAction = DeleteActionLeaf;
export interface DeliveryChargeSpecificationBase extends PriceSpecificationBase {
...
export interface DeliveryChargeSpecificationLeaf extends DeliveryChargeSpecificationBase {
  "@type": "DeliveryChargeSpecification";
}
/** The price for the delivery of an offer using a particular delivery method. */
export declare type DeliveryChargeSpecification = DeliveryChargeSpecificationLeaf;
export interface DeliveryEventBase extends EventBase {
...
export interface DeliveryEventLeaf extends DeliveryEventBase {
  "@type": "DeliveryEvent";
}
/** An event involving the delivery of an item. */
export declare type DeliveryEvent = DeliveryEventLeaf;
export interface DeliveryMethodLeaf extends EnumerationBase {
  "@type": "DeliveryMethod";
}
/**
...
export interface DeliveryTimeSettingsBase extends ThingBase {
...
export interface DeliveryTimeSettingsLeaf extends DeliveryTimeSettingsBase {
...
export interface DemandBase extends ThingBase {
  /** The payment method(s) accepted by seller for this offer. */
  "acceptedPaymentMethod"?: SchemaValue<LoanOrCredit | PaymentMethod | IdReference, "acceptedPaymentMethod">;
...
export interface DemandLeaf extends DemandBase {
  "@type": "Demand";
}
/** A demand entity represents the public, not necessarily binding, not necessarily exclusive, announcement by an organization or person to seek a certain type of goods or services. For describing demand using this type, the very same properties used for Offer apply. */
export declare type Demand = DemandLeaf;
export interface DentistBase extends MedicalOrganizationBase, LocalBusinessBase, LocalBusinessBase {
}
export interface DentistLeaf extends DentistBase {
  "@type": "Dentist";
}
/** A dentist. */
export declare type Dentist = DentistLeaf | string;
export interface DepartActionLeaf extends MoveActionBase {
  "@type": "DepartAction";
}
/** The act of departing from a place. An agent departs from an fromLocation for a destination, optionally with participants. */
export declare type DepartAction = DepartActionLeaf;
export interface DepartmentStoreLeaf extends LocalBusinessBase {
  "@type": "DepartmentStore";
}
/** A department store. */
export declare type DepartmentStore = DepartmentStoreLeaf | string;
export interface DepositAccountBase extends BankAccountBase, InvestmentOrDepositBase {
}
export interface DepositAccountLeaf extends DepositAccountBase {
  "@type": "DepositAccount";
}
/** A type of Bank Account with a main purpose of depositing funds to gain interest or other benefits. */
export declare type DepositAccount = DepositAccountLeaf;
export interface DermatologyLeaf extends LocalBusinessBase {
  "@type": "Dermatology";
}
/** A specific branch of medical science that pertains to diagnosis and treatment of disorders of skin. */
export declare type Dermatology = DermatologyLeaf | string;
export interface DiagnosticLabBase extends MedicalOrganizationBase {
  /** A diagnostic test or procedure offered by this lab. */
  "availableTest"?: SchemaValue<MedicalTest | IdReference, "availableTest">;
}
export interface DiagnosticLabLeaf extends DiagnosticLabBase {
  "@type": "DiagnosticLab";
}
/** A medical laboratory that offers on-site or off-site diagnostic services. */
export declare type DiagnosticLab = DiagnosticLabLeaf | string;
export interface DiagnosticProcedureLeaf extends MedicalProcedureBase {
  "@type": "DiagnosticProcedure";
}
/** A medical procedure intended primarily for diagnostic, as opposed to therapeutic, purposes. */
export declare type DiagnosticProcedure = DiagnosticProcedureLeaf;
export interface DietBase extends CreativeWorkBase, MedicalEntityBase {
...
export interface DietLeaf extends DietBase {
  "@type": "Diet";
}
/** A strategy of regulating the intake of food to achieve or maintain a specific health-related goal. */
export declare type Diet = DietLeaf;
export interface DietarySupplementBase extends SubstanceBase {
...
export interface DietarySupplementLeaf extends DietarySupplementBase {
  "@type": "DietarySupplement";
}
/** A product taken by mouth that contains a dietary ingredient intended to supplement the diet. Dietary ingredients may include vitamins, minerals, herbs or other botanicals, amino acids, and substances such as enzymes, organ tissues, glandulars and metabolites. */
export declare type DietarySupplement = DietarySupplementLeaf;
export interface DietNutritionLeaf extends LocalBusinessBase {
  "@type": "DietNutrition";
}
/** Dietetic and nutrition as a medical specialty. */
export declare type DietNutrition = DietNutritionLeaf | string;
export interface DigitalDocumentBase extends CreativeWorkBase {
...
export interface DigitalDocumentLeaf extends DigitalDocumentBase {
...
export interface DigitalDocumentPermissionBase extends ThingBase {
...
export interface DigitalDocumentPermissionLeaf extends DigitalDocumentPermissionBase {
  "@type": "DigitalDocumentPermission";
}
/** A permission for a particular person or group to access a particular file. */
export declare type DigitalDocumentPermission = DigitalDocumentPermissionLeaf;
export interface DigitalDocumentPermissionTypeLeaf extends EnumerationBase {
...
export interface DisagreeActionLeaf extends ActionBase {
  "@type": "DisagreeAction";
}
/** The act of expressing a difference of opinion with the object. An agent disagrees to/about an object (a proposition, topic or theme) with participants. */
export declare type DisagreeAction = DisagreeActionLeaf;
export interface DiscoverActionLeaf extends ActionBase {
  "@type": "DiscoverAction";
}
/** The act of discovering/finding an object. */
export declare type DiscoverAction = DiscoverActionLeaf;
export interface DiscussionForumPostingLeaf extends SocialMediaPostingBase {
  "@type": "DiscussionForumPosting";
}
/** A posting to a discussion forum. */
export declare type DiscussionForumPosting = DiscussionForumPostingLeaf;
export interface DislikeActionLeaf extends ActionBase {
  "@type": "DislikeAction";
}
...
export interface DistilleryLeaf extends FoodEstablishmentBase {
  "@type": "Distillery";
}
/** A distillery. */
export declare type Distillery = DistilleryLeaf | string;
export interface DonateActionBase extends TradeActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface DonateActionLeaf extends DonateActionBase {
  "@type": "DonateAction";
}
/** The act of providing goods, services, or money without compensation, often for philanthropic reasons. */
export declare type DonateAction = DonateActionLeaf;
export interface DoseScheduleBase extends MedicalEntityBase {
...
export interface DoseScheduleLeaf extends DoseScheduleBase {
  "@type": "DoseSchedule";
}
...
export interface DownloadActionLeaf extends TransferActionBase {
  "@type": "DownloadAction";
}
/** The act of downloading an object. */
export declare type DownloadAction = DownloadActionLeaf;
export interface DrawActionLeaf extends ActionBase {
  "@type": "DrawAction";
}
/** The act of producing a visual/graphical representation of an object, typically with a pen/pencil and paper as instruments. */
export declare type DrawAction = DrawActionLeaf;
export interface DrawingLeaf extends CreativeWorkBase {
  "@type": "Drawing";
}
/** A picture or diagram made with a pencil, pen, or crayon rather than paint. */
export declare type Drawing = DrawingLeaf;
export interface DrinkActionLeaf extends ConsumeActionBase {
  "@type": "DrinkAction";
}
/** The act of swallowing liquids. */
export declare type DrinkAction = DrinkActionLeaf;
export interface DriveWheelConfigurationValueLeaf extends QualitativeValueBase {
...
export interface DrugBase extends SubstanceBase {
  /** An active ingredient, typically chemical compounds and/or biologic substances. */
  "activeIngredient"?: SchemaValue<Text, "activeIngredient">;
...
export interface DrugLeaf extends DrugBase {
  "@type": "Drug";
}
...
export interface DrugClassBase extends MedicalEntityBase {
  /** Specifying a drug or medicine used in a medication procedure. */
  "drug"?: SchemaValue<Drug | IdReference, "drug">;
}
export interface DrugClassLeaf extends DrugClassBase {
  "@type": "DrugClass";
}
/** A class of medical drugs, e.g., statins. Classes can represent general pharmacological class, common mechanisms of action, common physiological effects, etc. */
export declare type DrugClass = DrugClassLeaf;
export interface DrugCostBase extends MedicalEntityBase {
...
export interface DrugCostLeaf extends DrugCostBase {
  "@type": "DrugCost";
}
...
export interface DrugCostCategoryLeaf extends EnumerationBase {
...
export interface DrugLegalStatusBase extends MedicalEntityBase {
  /** The location in which the status applies. */
  "applicableLocation"?: SchemaValue<AdministrativeArea | IdReference, "applicableLocation">;
}
export interface DrugLegalStatusLeaf extends DrugLegalStatusBase {
  "@type": "DrugLegalStatus";
}
/** The legal availability status of a medical drug. */
export declare type DrugLegalStatus = DrugLegalStatusLeaf;
export interface DrugPregnancyCategoryLeaf extends EnumerationBase {
...
export interface DrugPrescriptionStatusLeaf extends EnumerationBase {
...
export interface DrugStrengthBase extends MedicalEntityBase {
  /** An active ingredient, typically chemical compounds and/or biologic substances. */
  "activeIngredient"?: SchemaValue<Text, "activeIngredient">;
...
export interface DrugStrengthLeaf extends DrugStrengthBase {
  "@type": "DrugStrength";
}
/** A specific strength in which a medical drug is available in a specific country. */
export declare type DrugStrength = DrugStrengthLeaf;
export interface DryCleaningOrLaundryLeaf extends LocalBusinessBase {
...
export interface EatActionLeaf extends ConsumeActionBase {
  "@type": "EatAction";
}
/** The act of swallowing solid objects. */
export declare type EatAction = EatActionLeaf;
export interface EducationalAudienceBase extends AudienceBase {
  /** An educationalRole of an EducationalAudience. */
  "educationalRole"?: SchemaValue<Text, "educationalRole">;
}
export interface EducationalAudienceLeaf extends EducationalAudienceBase {
  "@type": "EducationalAudience";
}
/** An EducationalAudience. */
export declare type EducationalAudience = EducationalAudienceLeaf;
export interface EducationalOccupationalCredentialBase extends CreativeWorkBase {
...
export interface EducationalOccupationalCredentialLeaf extends EducationalOccupationalCredentialBase {
...
export interface EducationalOccupationalProgramBase extends ThingBase {
...
export interface EducationalOccupationalProgramLeaf extends EducationalOccupationalProgramBase {
...
export interface EducationalOrganizationBase extends OrganizationBase, CivicStructureBase {
  /** Alumni of an organization. */
  "alumni"?: SchemaValue<Person | IdReference, "alumni">;
}
export interface EducationalOrganizationLeaf extends EducationalOrganizationBase {
...
export interface EducationEventBase extends EventBase {
  /** The item being described is intended to assess the competency or learning outcome defined by the referenced term. */
  "assesses"?: SchemaValue<DefinedTerm | Text | IdReference, "assesses">;
  /** The level in terms of progression through an educational or training context. Examples of educational levels include 'beginner', 'intermediate' or 'advanced', and formal sets of level indicators. */
  "educationalLevel"?: SchemaValue<DefinedTerm | Text | URL | IdReference, "educationalLevel">;
...
export interface EducationEventLeaf extends EducationEventBase {
  "@type": "EducationEvent";
}
/** Event type: Education event. */
export declare type EducationEvent = EducationEventLeaf;
export interface ElectricianLeaf extends LocalBusinessBase {
  "@type": "Electrician";
}
/** An electrician. */
export declare type Electrician = ElectricianLeaf | string;
export interface ElectronicsStoreLeaf extends LocalBusinessBase {
  "@type": "ElectronicsStore";
}
/** An electronics store. */
export declare type ElectronicsStore = ElectronicsStoreLeaf | string;
export interface ElementarySchoolLeaf extends EducationalOrganizationBase {
  "@type": "ElementarySchool";
}
/** An elementary school. */
export declare type ElementarySchool = ElementarySchoolLeaf | string;
export interface EmailMessageLeaf extends MessageBase {
  "@type": "EmailMessage";
}
/** An email message. */
export declare type EmailMessage = EmailMessageLeaf;
export interface EmbassyLeaf extends CivicStructureBase {
  "@type": "Embassy";
}
/** An embassy. */
export declare type Embassy = EmbassyLeaf | string;
export interface EmergencyLeaf extends LocalBusinessBase {
  "@type": "Emergency";
}
...
export declare type Emergency = EmergencyLeaf | string;
export interface EmergencyServiceLeaf extends LocalBusinessBase {
  "@type": "EmergencyService";
}
/** An emergency service, such as a fire station or ER. */
export declare type EmergencyService = EmergencyServiceLeaf | FireStation | Hospital | PoliceStation | string;
export interface EmployerAggregateRatingLeaf extends AggregateRatingBase {
  "@type": "EmployerAggregateRating";
}
/** An aggregate rating of an Organization related to its role as an employer. */
export declare type EmployerAggregateRating = EmployerAggregateRatingLeaf;
export interface EmployerReviewLeaf extends ReviewBase {
  "@type": "EmployerReview";
}
...
export interface EmploymentAgencyLeaf extends LocalBusinessBase {
  "@type": "EmploymentAgency";
}
/** An employment agency. */
export declare type EmploymentAgency = EmploymentAgencyLeaf | string;
export interface EndorseActionBase extends ActionBase {
  /** A sub property of participant. The person/organization being supported. */
  "endorsee"?: SchemaValue<Organization | Person | IdReference, "endorsee">;
}
export interface EndorseActionLeaf extends EndorseActionBase {
  "@type": "EndorseAction";
}
/** An agent approves/certifies/likes/supports/sanction an object. */
export declare type EndorseAction = EndorseActionLeaf;
export interface EndorsementRatingLeaf extends RatingBase {
...
export interface EnergyConsumptionDetailsBase extends ThingBase {
...
export interface EnergyConsumptionDetailsLeaf extends EnergyConsumptionDetailsBase {
...
export interface EnergyEfficiencyEnumerationLeaf extends EnumerationBase {
...
export interface EnergyStarEnergyEfficiencyEnumerationLeaf extends EnumerationBase {
...
export interface EngineSpecificationBase extends ThingBase {
  /**
...
export interface EngineSpecificationLeaf extends EngineSpecificationBase {
  "@type": "EngineSpecification";
}
/** Information about the engine of the vehicle. A vehicle can have multiple engines represented by multiple engine specification entities. */
export declare type EngineSpecification = EngineSpecificationLeaf;
export interface EntertainmentBusinessLeaf extends LocalBusinessBase {
...
export interface EntryPointLeaf extends EntryPointBase {
  "@type": "EntryPoint";
}
/** An entry point, within some Web-based protocol. */
export declare type EntryPoint = EntryPointLeaf | string;
export interface EnumerationBase extends ThingBase {
  /** Relates a term (i.e. a property, class or enumeration) to one that supersedes it. */
  "supersededBy"?: SchemaValue<Class | Enumeration | Property | IdReference, "supersededBy">;
}
export interface EnumerationLeaf extends EnumerationBase {
  "@type": "Enumeration";
}
...
export interface EpisodeBase extends CreativeWorkBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface EpisodeLeaf extends EpisodeBase {
  "@type": "Episode";
}
/** A media episode (e.g. TV, radio, video game) which can be part of a series or season. */
export declare type Episode = EpisodeLeaf | PodcastEpisode | RadioEpisode | TVEpisode;
export interface EUEnergyEfficiencyEnumerationLeaf extends EnumerationBase {
...
export interface EventBase extends ThingBase {
  /** The subject matter of the content. */
  "about"?: SchemaValue<Thing | IdReference, "about">;
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
...
export interface EventLeaf extends EventBase {
  "@type": "Event";
}
...
export interface EventAttendanceModeEnumerationLeaf extends EnumerationBase {
...
export interface EventReservationLeaf extends ReservationBase {
...
export interface EventSeriesBase extends ThingBase, EventBase {
}
export interface EventSeriesLeaf extends EventSeriesBase {
  "@type": "EventSeries";
}
/**
...
export interface EventStatusTypeLeaf extends EnumerationBase {
...
export interface EventVenueLeaf extends CivicStructureBase {
  "@type": "EventVenue";
}
/** An event venue. */
export declare type EventVenue = EventVenueLeaf | string;
export interface ExchangeRateSpecificationBase extends ThingBase {
  /**
   * The currency in which the monetary amount is expressed.
   *
   * Use standard formats: {@link http://en.wikipedia.org/wiki/ISO_4217 ISO 4217 currency format} e.g. "USD"; {@link https://en.wikipedia.org/wiki/List_of_cryptocurrencies Ticker symbol} for cryptocurrencies e.g. "BTC"; well known names for {@link https://en.wikipedia.org/wiki/Local_exchange_trading_system Local Exchange Tradings Systems} (LETS) and other currency types e.g. "Ithaca HOUR".
...
export interface ExchangeRateSpecificationLeaf extends ExchangeRateSpecificationBase {
  "@type": "ExchangeRateSpecification";
}
/** A structured value representing exchange rate. */
export declare type ExchangeRateSpecification = ExchangeRateSpecificationLeaf;
export interface ExerciseActionBase extends PlayActionBase {
  /**
...
export interface ExerciseActionLeaf extends ExerciseActionBase {
  "@type": "ExerciseAction";
}
/** The act of participating in exertive activity for the purposes of improving health and fitness. */
export declare type ExerciseAction = ExerciseActionLeaf;
export interface ExerciseGymLeaf extends LocalBusinessBase {
  "@type": "ExerciseGym";
}
/** A gym. */
export declare type ExerciseGym = ExerciseGymLeaf | string;
export interface ExercisePlanBase extends CreativeWorkBase, PhysicalActivityBase {
...
export interface ExercisePlanLeaf extends ExercisePlanBase {
  "@type": "ExercisePlan";
}
/** Fitness-related activity designed for a specific health-related purpose, including defined exercise routines as well as activity prescribed by a clinician. */
export declare type ExercisePlan = ExercisePlanLeaf;
export interface ExhibitionEventLeaf extends EventBase {
  "@type": "ExhibitionEvent";
}
/** Event type: Exhibition event, e.g. at a museum, library, archive, tradeshow, ... */
export declare type ExhibitionEvent = ExhibitionEventLeaf;
export interface FAQPageLeaf extends WebPageBase {
  "@type": "FAQPage";
}
...
export interface FastFoodRestaurantLeaf extends FoodEstablishmentBase {
  "@type": "FastFoodRestaurant";
}
/** A fast-food restaurant. */
export declare type FastFoodRestaurant = FastFoodRestaurantLeaf | string;
export interface FestivalLeaf extends EventBase {
  "@type": "Festival";
}
/** Event type: Festival. */
export declare type Festival = FestivalLeaf;
export interface FilmActionLeaf extends ActionBase {
  "@type": "FilmAction";
}
/** The act of capturing sound and moving images on film, video, or digitally. */
export declare type FilmAction = FilmActionLeaf;
export interface FinancialProductBase extends ServiceBase {
...
export interface FinancialProductLeaf extends FinancialProductBase {
...
export interface FinancialServiceBase extends LocalBusinessBase {
  /** Description of fees, commissions, and other terms applied either to a class of financial product, or by a financial service organization. */
  "feesAndCommissionsSpecification"?: SchemaValue<Text | URL, "feesAndCommissionsSpecification">;
}
export interface FinancialServiceLeaf extends FinancialServiceBase {
...
export interface FindActionLeaf extends ActionBase {
  "@type": "FindAction";
}
/**
...
export interface FireStationBase extends LocalBusinessBase, CivicStructureBase {
}
export interface FireStationLeaf extends FireStationBase {
  "@type": "FireStation";
}
/** A fire station. With firemen. */
export declare type FireStation = FireStationLeaf | string;
export interface FlightBase extends TripBase {
...
export interface FlightLeaf extends FlightBase {
  "@type": "Flight";
}
/** An airline flight. */
export declare type Flight = FlightLeaf;
export interface FlightReservationBase extends ReservationBase {
...
export interface FlightReservationLeaf extends FlightReservationBase {
...
export interface FloorPlanBase extends ThingBase {
  /** An amenity feature (e.g. a characteristic or service) of the Accommodation. This generic property does not make a statement about whether the feature is included in an offer for the main accommodation or available at extra costs. */
  "amenityFeature"?: SchemaValue<LocationFeatureSpecification | IdReference, "amenityFeature">;
  /** The size of the accommodation, e.g. in square meter or squarefoot. Typical unit code(s): MTK for square meter, FTK for square foot, or YDK for square yard */
  "floorSize"?: SchemaValue<QuantitativeValue | IdReference, "floorSize">;
...
export interface FloorPlanLeaf extends FloorPlanBase {
  "@type": "FloorPlan";
}
...
export interface FloristLeaf extends LocalBusinessBase {
  "@type": "Florist";
}
/** A florist. */
export declare type Florist = FloristLeaf | string;
export interface FMRadioChannelLeaf extends BroadcastChannelBase {
  "@type": "FMRadioChannel";
}
/** A radio channel that uses FM. */
export declare type FMRadioChannel = FMRadioChannelLeaf;
export interface FollowActionBase extends ActionBase {
  /** A sub property of object. The person or organization being followed. */
  "followee"?: SchemaValue<Organization | Person | IdReference, "followee">;
}
export interface FollowActionLeaf extends FollowActionBase {
  "@type": "FollowAction";
}
/**
...
export interface FoodEstablishmentBase extends LocalBusinessBase {
...
export interface FoodEstablishmentLeaf extends FoodEstablishmentBase {
...
export interface FoodEstablishmentReservationBase extends ReservationBase {
  /**
   * The endTime of something. For a reserved event or service (e.g. FoodEstablishmentReservation), the time that it is expected to end. For actions that span a period of time, when the action was performed. e.g. John wrote a book from January to _December_. For media, including audio and video, it's the time offset of the end of a clip within a larger file.
   *
   * Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
...
export interface FoodEstablishmentReservationLeaf extends FoodEstablishmentReservationBase {
...
export interface FoodEventLeaf extends EventBase {
  "@type": "FoodEvent";
}
/** Event type: Food event. */
export declare type FoodEvent = FoodEventLeaf;
export interface FoodServiceLeaf extends ServiceBase {
  "@type": "FoodService";
}
/** A food service, like breakfast, lunch, or dinner. */
export declare type FoodService = FoodServiceLeaf;
export interface FundingAgencyLeaf extends OrganizationBase {
  "@type": "FundingAgency";
}
/**
...
export interface FundingSchemeLeaf extends OrganizationBase {
  "@type": "FundingScheme";
}
...
export interface FurnitureStoreLeaf extends LocalBusinessBase {
  "@type": "FurnitureStore";
}
/** A furniture store. */
export declare type FurnitureStore = FurnitureStoreLeaf | string;
export interface GameBase extends CreativeWorkBase {
...
export interface GameLeaf extends GameBase {
  "@type": "Game";
}
/** The Game type represents things which are games. These are typically rule-governed recreational activities, e.g. role-playing games in which players assume the role of characters in a fictional setting. */
export declare type Game = GameLeaf | VideoGame;
export interface GamePlayModeLeaf extends EnumerationBase {
  "@type": "GamePlayMode";
}
...
export interface GameServerBase extends ThingBase {
...
export interface GameServerLeaf extends GameServerBase {
  "@type": "GameServer";
}
/** Server that provides game interaction in a multiplayer game. */
export declare type GameServer = GameServerLeaf;
export interface GameServerStatusLeaf extends EnumerationBase {
...
export interface GeneLeaf extends GeneBase {
  "@type": "Gene";
}
...
export interface GeneralContractorLeaf extends LocalBusinessBase {
  "@type": "GeneralContractor";
}
/** A general contractor. */
export declare type GeneralContractor = GeneralContractorLeaf | string;
export interface GeoCircleBase extends GeoShapeBase {
...
export interface GeoCircleLeaf extends GeoCircleBase {
  "@type": "GeoCircle";
}
...
export interface GeoCoordinatesBase extends ThingBase {
...
export interface GeoCoordinatesLeaf extends GeoCoordinatesBase {
  "@type": "GeoCoordinates";
}
/** The geographic coordinates of a place or event. */
export declare type GeoCoordinates = GeoCoordinatesLeaf;
export interface GeoShapeBase extends ThingBase {
  /** Physical address of the item. */
  "address"?: SchemaValue<PostalAddress | Text | IdReference, "address">;
  /** The country. For example, USA. You can also provide the two-letter {@link http://en.wikipedia.org/wiki/ISO_3166-1 ISO 3166-1 alpha-2 country code}. */
  "addressCountry"?: SchemaValue<Country | Text | IdReference, "addressCountry">;
...
export interface GeoShapeLeaf extends GeoShapeBase {
  "@type": "GeoShape";
}
/** The geographic shape of a place. A GeoShape can be described using several properties whose values are based on latitude/longitude pairs. Either whitespace or commas can be used to separate latitude and longitude; whitespace should be used when writing a list of several such points. */
export declare type GeoShape = GeoShapeLeaf | GeoCircle;
export interface GeospatialGeometryBase extends ThingBase {
...
export interface GeospatialGeometryLeaf extends GeospatialGeometryBase {
  "@type": "GeospatialGeometry";
}
/** (Eventually to be defined as) a supertype of GeoShape designed to accommodate definitions from Geo-Spatial best practices. */
export declare type GeospatialGeometry = GeospatialGeometryLeaf;
export interface GeriatricLeaf extends LocalBusinessBase {
  "@type": "Geriatric";
}
...
export declare type Geriatric = GeriatricLeaf | string;
export interface GiveActionBase extends TransferActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface GiveActionLeaf extends GiveActionBase {
  "@type": "GiveAction";
}
/**
...
export interface GolfCourseLeaf extends LocalBusinessBase {
  "@type": "GolfCourse";
}
/** A golf course. */
export declare type GolfCourse = GolfCourseLeaf | string;
export interface GovernmentBenefitsTypeLeaf extends EnumerationBase {
...
export interface GovernmentBuildingLeaf extends CivicStructureBase {
...
export interface GovernmentOfficeLeaf extends LocalBusinessBase {
  "@type": "GovernmentOffice";
}
/** A government office—for example, an IRS or DMV office. */
export declare type GovernmentOffice = GovernmentOfficeLeaf | PostOffice | string;
export interface GovernmentOrganizationLeaf extends OrganizationBase {
  "@type": "GovernmentOrganization";
}
/** A governmental organization or agency. */
export declare type GovernmentOrganization = GovernmentOrganizationLeaf | string;
export interface GovernmentPermitLeaf extends PermitBase {
  "@type": "GovernmentPermit";
}
/** A permit issued by a government agency. */
export declare type GovernmentPermit = GovernmentPermitLeaf;
export interface GovernmentServiceBase extends ServiceBase {
...
export interface GovernmentServiceLeaf extends GovernmentServiceBase {
  "@type": "GovernmentService";
}
/** A service provided by a government organization, e.g. food stamps, veterans benefits, etc. */
export declare type GovernmentService = GovernmentServiceLeaf;
export interface GrantBase extends ThingBase {
  /** Indicates an item funded or sponsored through a {@link https://schema.org/Grant Grant}. */
  "fundedItem"?: SchemaValue<Thing | IdReference, "fundedItem">;
  /** A person or organization that supports a thing through a pledge, promise, or financial contribution. e.g. a sponsor of a Medical Study or a corporate sponsor of an event. */
  "sponsor"?: SchemaValue<Organization | Person | IdReference, "sponsor">;
}
export interface GrantLeaf extends GrantBase {
  "@type": "Grant";
}
/**
...
export interface GroceryStoreLeaf extends LocalBusinessBase {
  "@type": "GroceryStore";
}
/** A grocery store. */
export declare type GroceryStore = GroceryStoreLeaf | string;
export interface GuideBase extends CreativeWorkBase {
  /** This Review or Rating is relevant to this part or facet of the itemReviewed. */
  "reviewAspect"?: SchemaValue<Text, "reviewAspect">;
}
export interface GuideLeaf extends GuideBase {
  "@type": "Guide";
}
...
export interface GynecologicLeaf extends LocalBusinessBase {
  "@type": "Gynecologic";
}
...
export declare type Gynecologic = GynecologicLeaf | string;
export interface HackathonLeaf extends EventBase {
  "@type": "Hackathon";
}
/** A {@link https://en.wikipedia.org/wiki/Hackathon hackathon} event. */
export declare type Hackathon = HackathonLeaf;
export interface HairSalonLeaf extends LocalBusinessBase {
  "@type": "HairSalon";
}
/** A hair salon. */
export declare type HairSalon = HairSalonLeaf | string;
export interface HardwareStoreLeaf extends LocalBusinessBase {
  "@type": "HardwareStore";
}
/** A hardware store. */
export declare type HardwareStore = HardwareStoreLeaf | string;
export interface HealthAndBeautyBusinessLeaf extends LocalBusinessBase {
...
export interface HealthAspectEnumerationLeaf extends EnumerationBase {
...
export interface HealthClubBase extends LocalBusinessBase, LocalBusinessBase {
}
export interface HealthClubLeaf extends HealthClubBase {
  "@type": "HealthClub";
}
/** A health club. */
export declare type HealthClub = HealthClubLeaf | string;
export interface HealthInsurancePlanBase extends ThingBase {
...
export interface HealthInsurancePlanLeaf extends HealthInsurancePlanBase {
  "@type": "HealthInsurancePlan";
}
/** A US-style health insurance plan, including PPOs, EPOs, and HMOs. */
export declare type HealthInsurancePlan = HealthInsurancePlanLeaf;
export interface HealthPlanCostSharingSpecificationBase extends ThingBase {
...
export interface HealthPlanCostSharingSpecificationLeaf extends HealthPlanCostSharingSpecificationBase {
...
export interface HealthPlanFormularyBase extends ThingBase {
...
export interface HealthPlanFormularyLeaf extends HealthPlanFormularyBase {
  "@type": "HealthPlanFormulary";
}
/** For a given health insurance plan, the specification for costs and coverage of prescription drugs. */
export declare type HealthPlanFormulary = HealthPlanFormularyLeaf;
export interface HealthPlanNetworkBase extends ThingBase {
  /** Whether The costs to the patient for services under this network or formulary. */
  "healthPlanCostSharing"?: SchemaValue<Boolean, "healthPlanCostSharing">;
...
export interface HealthPlanNetworkLeaf extends HealthPlanNetworkBase {
  "@type": "HealthPlanNetwork";
}
/** A US-style health insurance plan network. */
export declare type HealthPlanNetwork = HealthPlanNetworkLeaf;
export interface HealthTopicContentBase extends CreativeWorkBase {
...
export interface HealthTopicContentLeaf extends HealthTopicContentBase {
...
export interface HighSchoolLeaf extends EducationalOrganizationBase {
  "@type": "HighSchool";
}
/** A high school. */
export declare type HighSchool = HighSchoolLeaf | string;
export interface HinduTempleLeaf extends CivicStructureBase {
  "@type": "HinduTemple";
}
/** A Hindu temple. */
export declare type HinduTemple = HinduTempleLeaf | string;
export interface HobbyShopLeaf extends LocalBusinessBase {
  "@type": "HobbyShop";
}
/** A store that sells materials useful or necessary for various hobbies. */
export declare type HobbyShop = HobbyShopLeaf | string;
export interface HomeAndConstructionBusinessLeaf extends LocalBusinessBase {
...
export interface HomeGoodsStoreLeaf extends LocalBusinessBase {
  "@type": "HomeGoodsStore";
}
/** A home goods store. */
export declare type HomeGoodsStore = HomeGoodsStoreLeaf | string;
export interface HospitalBase extends CivicStructureBase, MedicalOrganizationBase, LocalBusinessBase {
...
export interface HospitalLeaf extends HospitalBase {
  "@type": "Hospital";
}
/** A hospital. */
export declare type Hospital = HospitalLeaf | string;
export interface HostelLeaf extends LodgingBusinessBase {
  "@type": "Hostel";
}
/**
...
export interface HotelLeaf extends LodgingBusinessBase {
  "@type": "Hotel";
}
/**
...
export interface HotelRoomBase extends AccommodationBase {
...
export interface HotelRoomLeaf extends HotelRoomBase {
  "@type": "HotelRoom";
}
/**
...
export interface HouseBase extends AccommodationBase {
  /** The number of rooms (excluding bathrooms and closets) of the accommodation or lodging business. Typical unit code(s): ROM for room or C62 for no unit. The type of room can be put in the unitText property of the QuantitativeValue. */
  "numberOfRooms"?: SchemaValue<Number | QuantitativeValue | IdReference, "numberOfRooms">;
}
export interface HouseLeaf extends HouseBase {
  "@type": "House";
}
...
export interface HousePainterLeaf extends LocalBusinessBase {
  "@type": "HousePainter";
}
/** A house painting service. */
export declare type HousePainter = HousePainterLeaf | string;
export interface HowToBase extends CreativeWorkBase {
...
export interface HowToLeaf extends HowToBase {
  "@type": "HowTo";
}
/** Instructions that explain how to achieve a result by performing a sequence of steps. */
export declare type HowTo = HowToLeaf | Recipe;
export interface HowToDirectionBase extends CreativeWorkBase, ListItemBase {
...
export interface HowToSectionLeaf extends HowToSectionBase {
  "@type": "HowToSection";
}
/** A sub-grouping of steps in the instructions for how to achieve a result (e.g. steps for making a pie crust within a pie recipe). */
export declare type HowToSection = HowToSectionLeaf;
export interface HowToStepBase extends CreativeWorkBase, ListItemBase, ItemListBase {
}
export interface HowToStepLeaf extends HowToStepBase {
  "@type": "HowToStep";
}
/** A step in the instructions for how to achieve a result. It is an ordered list with HowToDirection and/or HowToTip items. */
export declare type HowToStep = HowToStepLeaf;
export interface HowToSupplyBase extends HowToItemBase {
  /** The estimated cost of the supply or supplies consumed when performing instructions. */
  "estimatedCost"?: SchemaValue<MonetaryAmount | Text | IdReference, "estimatedCost">;
}
export interface HowToSupplyLeaf extends HowToSupplyBase {
  "@type": "HowToSupply";
}
/** A supply consumed when performing the instructions for how to achieve a result. */
export declare type HowToSupply = HowToSupplyLeaf;
export interface HowToTipBase extends ListItemBase, CreativeWorkBase {
}
export interface HowToTipLeaf extends HowToTipBase {
  "@type": "HowToTip";
}
/** An explanation in the instructions for how to achieve a result. It provides supplementary information about a technique, supply, author's preference, etc. It can explain what could be done, or what should not be done, but doesn't specify what should be done (see HowToDirection). */
export declare type HowToTip = HowToTipLeaf;
export interface HowToToolLeaf extends HowToItemBase {
  "@type": "HowToTool";
}
/** A tool used (but not consumed) when performing instructions for how to achieve a result. */
export declare type HowToTool = HowToToolLeaf;
export interface HVACBusinessLeaf extends LocalBusinessBase {
  "@type": "HVACBusiness";
}
/** A business that provide Heating, Ventilation and Air Conditioning services. */
export declare type HVACBusiness = HVACBusinessLeaf | string;
export interface HyperTocBase extends CreativeWorkBase {
  /** A media object that encodes this CreativeWork. This property is a synonym for encoding. */
  "associatedMedia"?: SchemaValue<MediaObject | IdReference, "associatedMedia">;
...
export interface HyperTocLeaf extends HyperTocBase {
  "@type": "HyperToc";
}
...
export interface HyperTocEntryBase extends CreativeWorkBase {
  /** A media object that encodes this CreativeWork. This property is a synonym for encoding. */
  "associatedMedia"?: SchemaValue<MediaObject | IdReference, "associatedMedia">;
...
export interface HyperTocEntryLeaf extends HyperTocEntryBase {
  "@type": "HyperTocEntry";
}
...
export interface IceCreamShopLeaf extends FoodEstablishmentBase {
  "@type": "IceCreamShop";
}
/** An ice cream shop. */
export declare type IceCreamShop = IceCreamShopLeaf | string;
export interface IgnoreActionLeaf extends ActionBase {
  "@type": "IgnoreAction";
}
/** The act of intentionally disregarding the object. An agent ignores an object. */
export declare type IgnoreAction = IgnoreActionLeaf;
export interface ImageGalleryLeaf extends WebPageBase {
  "@type": "ImageGallery";
}
/** Web page type: Image gallery page. */
export declare type ImageGallery = ImageGalleryLeaf;
export interface ImageObjectBase extends MediaObjectBase {
  /** The caption for this object. For downloadable machine formats (closed caption, subtitles etc.) use MediaObject and indicate the {@link https://schema.org/encodingFormat encodingFormat}. */
  "caption"?: SchemaValue<MediaObject | Text | IdReference, "caption">;
  /** Represents textual captioning from a {@link https://schema.org/MediaObject MediaObject}, e.g. text of a 'meme'. */
  "embeddedTextCaption"?: SchemaValue<Text, "embeddedTextCaption">;
...
export interface ImageObjectLeaf extends ImageObjectBase {
  "@type": "ImageObject";
}
/** An image file. */
export declare type ImageObject = ImageObjectLeaf | Barcode | ImageObjectSnapshot;
export interface ImageObjectSnapshotLeaf extends ImageObjectBase {
...
export interface ImagingTestBase extends MedicalTestBase {
  /** Imaging technique used. */
  "imagingTechnique"?: SchemaValue<MedicalImagingTechnique | IdReference, "imagingTechnique">;
}
export interface ImagingTestLeaf extends ImagingTestBase {
  "@type": "ImagingTest";
}
/** Any medical imaging modality typically used for diagnostic purposes. */
export declare type ImagingTest = ImagingTestLeaf;
export interface IndividualProductBase extends ProductBase {
  /** The serial number or any alphanumeric identifier of a particular product. When attached to an offer, it is a shortcut for the serial number of the product included in the offer. */
  "serialNumber"?: SchemaValue<Text, "serialNumber">;
}
export interface IndividualProductLeaf extends IndividualProductBase {
  "@type": "IndividualProduct";
}
/** A single, identifiable product instance (e.g. a laptop with a particular serial number). */
export declare type IndividualProduct = IndividualProductLeaf;
export interface InfectiousAgentClassLeaf extends EnumerationBase {
...
export interface InfectiousDiseaseBase extends MedicalConditionBase {
...
export interface InfectiousDiseaseLeaf extends InfectiousDiseaseBase {
...
export interface InformActionBase extends CommunicateActionBase {
  /** Upcoming or past event associated with this place, organization, or action. */
  "event"?: SchemaValue<Event | IdReference, "event">;
}
export interface InformActionLeaf extends InformActionBase {
  "@type": "InformAction";
}
/** The act of notifying someone of information pertinent to them, with no expectation of a response. */
export declare type InformAction = InformActionLeaf | ConfirmAction | RsvpAction;
export interface InsertActionBase extends UpdateActionBase {
  /** A sub property of location. The final location of the object or the agent after the action. */
  "toLocation"?: SchemaValue<Place | IdReference, "toLocation">;
}
export interface InsertActionLeaf extends InsertActionBase {
  "@type": "InsertAction";
}
/** The act of adding at a specific location in an ordered collection. */
export declare type InsertAction = InsertActionLeaf | AppendAction | PrependAction;
export interface InstallActionLeaf extends ConsumeActionBase {
  "@type": "InstallAction";
}
/** The act of installing an application. */
export declare type InstallAction = InstallActionLeaf;
export interface InsuranceAgencyLeaf extends FinancialServiceBase {
...
export interface InteractActionLeaf extends ActionBase {
  "@type": "InteractAction";
}
...
export interface InteractionCounterBase extends ThingBase {
  /**
   * The endTime of something. For a reserved event or service (e.g. FoodEstablishmentReservation), the time that it is expected to end. For actions that span a period of time, when the action was performed. e.g. John wrote a book from January to _December_. For media, including audio and video, it's the time offset of the end of a clip within a larger file.
   *
   * Note that Event uses startDate/endDate instead of startTime/endTime, even when describing dates with times. This situation may be clarified in future revisions.
...
export interface InteractionCounterLeaf extends InteractionCounterBase {
  "@type": "InteractionCounter";
}
/** A summary of how users have interacted with this CreativeWork. In most cases, authors will use a subtype to specify the specific type of interaction. */
export declare type InteractionCounter = InteractionCounterLeaf;
export interface InternetCafeLeaf extends LocalBusinessBase {
  "@type": "InternetCafe";
}
/** An internet cafe. */
export declare type InternetCafe = InternetCafeLeaf | string;
export interface InvestmentFundLeaf extends InvestmentOrDepositBase {
  "@type": "InvestmentFund";
}
/** A company or fund that gathers capital from a number of investors to create a pool of money that is then re-invested into stocks, bonds and other assets. */
export declare type InvestmentFund = InvestmentFundLeaf;
export interface InvestmentOrDepositBase extends FinancialProductBase {
  /** The amount of money. */
  "amount"?: SchemaValue<MonetaryAmount | Number | IdReference, "amount">;
}
export interface InvestmentOrDepositLeaf extends InvestmentOrDepositBase {
...
export interface InviteActionBase extends CommunicateActionBase {
  /** Upcoming or past event associated with this place, organization, or action. */
  "event"?: SchemaValue<Event | IdReference, "event">;
}
export interface InviteActionLeaf extends InviteActionBase {
  "@type": "InviteAction";
}
/** The act of asking someone to attend an event. Reciprocal of RsvpAction. */
export declare type InviteAction = InviteActionLeaf;
export interface InvoiceBase extends ThingBase {
...
export interface ItemListLeaf extends ItemListBase {
  "@type": "ItemList";
}
...
export interface ItemListOrderTypeLeaf extends EnumerationBase {
...
export interface ItemPageLeaf extends WebPageBase {
  "@type": "ItemPage";
}
/** A page devoted to a single item, such as a particular product or hotel. */
export declare type ItemPage = ItemPageLeaf;
export interface JewelryStoreLeaf extends LocalBusinessBase {
  "@type": "JewelryStore";
}
/** A jewelry store. */
export declare type JewelryStore = JewelryStoreLeaf | string;
export interface JobPostingBase extends ThingBase {
  ...
  "hiringOrganization"?: SchemaValue<Organization | IdReference, "hiringOrganization">;
...
export interface JobPostingLeaf extends JobPostingBase {
  "@type": "JobPosting";
}
/** A listing that describes a job opening in a certain organization. */
export declare type JobPosting = JobPostingLeaf;
export interface JoinActionBase extends ActionBase {
  /** Upcoming or past event associated with this place, organization, or action. */
  "event"?: SchemaValue<Event | IdReference, "event">;
}
export interface JoinActionLeaf extends JoinActionBase {
  "@type": "JoinAction";
}
/**
...
export interface JointBase extends AnatomicalStructureBase {
...
export interface JointLeaf extends JointBase {
  "@type": "Joint";
}
/** The anatomical location at which two or more bones make contact. */
export declare type Joint = JointLeaf;
export interface LakeBodyOfWaterLeaf extends PlaceBase {
  "@type": "LakeBodyOfWater";
}
/** A lake (for example, Lake Pontrachain). */
export declare type LakeBodyOfWater = LakeBodyOfWaterLeaf | string;
export interface LandformLeaf extends PlaceBase {
  "@type": "Landform";
}
/** A landform or physical feature. Landform elements include mountains, plains, lakes, rivers, seascape and oceanic waterbody export interface features such as bays, peninsulas, seas and so forth, including sub-aqueous terrain features such as submersed mountain ranges, volcanoes, and the great ocean basins. */
export declare type Landform = LandformLeaf | BodyOfWater | Continent | Mountain | Volcano | string;
export interface LandmarksOrHistoricalBuildingsLeaf extends PlaceBase {
  "@type": "LandmarksOrHistoricalBuildings";
}
/** An historical landmark or building. */
export declare type LandmarksOrHistoricalBuildings = LandmarksOrHistoricalBuildingsLeaf | string;
export interface LanguageLeaf extends ThingBase {
  "@type": "Language";
}
...
export interface LearningResourceBase extends CreativeWorkBase {
  /** The item being described is intended to assess the competency or learning outcome defined by the referenced term. */
  "assesses"?: SchemaValue<DefinedTerm | Text | IdReference, "assesses">;
  /** Knowledge, skill, ability or personal attribute that must be demonstrated by a person or other entity in order to do something such as earn an Educational Occupational Credential or understand a LearningResource. */
  "competencyRequired"?: SchemaValue<DefinedTerm | Text | URL | IdReference, "competencyRequired">;
...
export interface LearningResourceLeaf extends LearningResourceBase {
...
export interface LeaveActionBase extends ActionBase {
  /** Upcoming or past event associated with this place, organization, or action. */
  "event"?: SchemaValue<Event | IdReference, "event">;
}
export interface LeaveActionLeaf extends LeaveActionBase {
  "@type": "LeaveAction";
}
/**
...
export interface LegalForceStatusLeaf extends EnumerationBase {
...
export interface LegalServiceLeaf extends LocalBusinessBase {
  "@type": "LegalService";
}
/**
...
export interface LegalValueLevelLeaf extends EnumerationBase {
...
export interface LegislationBase extends CreativeWorkBase {
  /** Indicates a legal jurisdiction, e.g. of some legislation, or where some government service is based. */
  "jurisdiction"?: SchemaValue<AdministrativeArea | Text | IdReference, "jurisdiction">;
...
export interface LegislationLeaf extends LegislationBase {
  "@type": "Legislation";
}
/** A legal document such as an act, decree, bill, etc. (enforceable or not) or a component of a legal act (like an article). */
export declare type Legislation = LegislationLeaf | LegislationObject;
export interface LegislationObjectBase extends MediaObjectBase, LegislationBase {
...
export interface LibraryLeaf extends LocalBusinessBase {
  "@type": "Library";
}
/** A library. */
export declare type Library = LibraryLeaf | string;
export interface LibrarySystemLeaf extends OrganizationBase {
  "@type": "LibrarySystem";
}
...
export interface LifestyleModificationLeaf extends MedicalEntityBase {
...
export interface LigamentLeaf extends AnatomicalStructureBase {
  "@type": "Ligament";
}
/** A short band of tough, flexible, fibrous connective tissue that functions to connect multiple bones, cartilages, and structurally support joints. */
export declare type Ligament = LigamentLeaf;
export interface LikeActionLeaf extends ActionBase {
  "@type": "LikeAction";
}
/** The act of expressing a positive sentiment about the object. An agent likes an object (a proposition, topic or theme) with participants. */
export declare type LikeAction = LikeActionLeaf;
export interface LiquorStoreLeaf extends LocalBusinessBase {
  "@type": "LiquorStore";
}
/** A shop that sells alcoholic drinks such as wine, beer, whisky and other spirits. */
export declare type LiquorStore = LiquorStoreLeaf | string;
export interface ListenActionLeaf extends ConsumeActionBase {
  "@type": "ListenAction";
}
/** The act of consuming audio content. */
export declare type ListenAction = ListenActionLeaf;
export interface ListItemBase extends ThingBase {
  /** An entity represented by an entry in a list or data feed (e.g. an 'artist' in a list of 'artists')’. */
  "item"?: SchemaValue<Thing | IdReference, "item">;
...
export interface ListItemLeaf extends ListItemBase {
  "@type": "ListItem";
}
/** An list item, e.g. a step in a checklist or how-to description. */
export declare type ListItem = ListItemLeaf | HowToDirection | HowToItem | HowToSection | HowToStep | HowToTip;
export interface LiteraryEventLeaf extends EventBase {
  "@type": "LiteraryEvent";
}
/** Event type: Literary event. */
export declare type LiteraryEvent = LiteraryEventLeaf;
export interface LiveBlogPostingBase extends SocialMediaPostingBase {
...
export interface LiveBlogPostingLeaf extends LiveBlogPostingBase {
...
export interface LoanOrCreditBase extends FinancialProductBase {
  /** The amount of money. */
  "amount"?: SchemaValue<MonetaryAmount | Number | IdReference, "amount">;
  /**
   * The currency in which the monetary amount is expressed.
...
export interface LoanOrCreditLeaf extends LoanOrCreditBase {
  "@type": "LoanOrCredit";
}
/** A financial product for the loaning of an amount of money, or line of credit, under agreed terms and charges. */
export declare type LoanOrCredit = LoanOrCreditLeaf | CreditCard | MortgageLoan;
export interface LocalBusinessBase extends OrganizationBase, PlaceBase {
  /**
...
export interface LocalBusinessLeaf extends LocalBusinessBase {
  "@type": "LocalBusiness";
}
...
export interface LocationFeatureSpecificationBase extends PropertyValueBase {
  /** The hours during which this service or contact is available. */
  "hoursAvailable"?: SchemaValue<OpeningHoursSpecification | IdReference, "hoursAvailable">;
  /** The date when the item becomes valid. */
  "validFrom"?: SchemaValue<Date | DateTime, "validFrom">;
...
export interface LocationFeatureSpecificationLeaf extends LocationFeatureSpecificationBase {
  "@type": "LocationFeatureSpecification";
}
/** Specifies a location feature by providing a structured value representing a feature of an accommodation as a property-value pair of varying degrees of formality. */
export declare type LocationFeatureSpecification = LocationFeatureSpecificationLeaf;
export interface LocksmithLeaf extends LocalBusinessBase {
  "@type": "Locksmith";
}
/** A locksmith. */
export declare type Locksmith = LocksmithLeaf | string;
export interface LodgingBusinessBase extends LocalBusinessBase {
  /** An amenity feature (e.g. a characteristic or service) of the Accommodation. This generic property does not make a statement about whether the feature is included in an offer for the main accommodation or available at extra costs. */
  "amenityFeature"?: SchemaValue<LocationFeatureSpecification | IdReference, "amenityFeature">;
  /** An intended audience, i.e. a group for whom something was created. */
  "audience"?: SchemaValue<Audience | IdReference, "audience">;
...
export interface LodgingBusinessLeaf extends LodgingBusinessBase {
...
export interface LodgingReservationBase extends ReservationBase {
  /** The earliest someone may check into a lodging establishment. */
  "checkinTime"?: SchemaValue<DateTime | Time, "checkinTime">;
  /** The latest someone may check out of a lodging establishment. */
  "checkoutTime"?: SchemaValue<DateTime | Time, "checkoutTime">;
...
export interface LodgingReservationLeaf extends LodgingReservationBase {
...
export interface LoseActionBase extends ActionBase {
  /** A sub property of participant. The winner of the action. */
  "winner"?: SchemaValue<Person | IdReference, "winner">;
}
export interface LoseActionLeaf extends LoseActionBase {
  "@type": "LoseAction";
}
/** The act of being defeated in a competitive activity. */
export declare type LoseAction = LoseActionLeaf;
export interface LymphaticVesselBase extends AnatomicalStructureBase {
...
export interface LymphaticVesselLeaf extends LymphaticVesselBase {
  "@type": "LymphaticVessel";
}
/** A type of blood vessel that specifically carries lymph fluid unidirectionally toward the heart. */
export declare type LymphaticVessel = LymphaticVesselLeaf;
export interface ManuscriptLeaf extends CreativeWorkBase {
  "@type": "Manuscript";
}
/** A book, document, or piece of music written by hand rather than typed or printed. */
export declare type Manuscript = ManuscriptLeaf;
export interface MapBase extends CreativeWorkBase {
  /** Indicates the kind of Map, from the MapCategoryType Enumeration. */
  "mapType"?: SchemaValue<MapCategoryType | IdReference, "mapType">;
}
export interface MapLeaf extends MapBase {
  "@type": "Map";
}
/** A map. */
export declare type Map = MapLeaf;
export interface MapCategoryTypeLeaf extends EnumerationBase {
...
export interface MarryActionLeaf extends ActionBase {
  "@type": "MarryAction";
}
...
export interface MathSolverBase extends CreativeWorkBase {
  /** A mathematical expression (e.g. 'x^2-3x=0') that may be solved for a specific variable, simplified, or transformed. This can take many formats, e.g. LaTeX, Ascii-Math, or math as you would write with a keyboard. */
  "mathExpression"?: SchemaValue<SolveMathAction | Text | IdReference, "mathExpression">;
}
export interface MathSolverLeaf extends MathSolverBase {
  "@type": "MathSolver";
}
/** A math solver which is capable of solving a subset of mathematical problems. */
export declare type MathSolver = MathSolverLeaf;
export interface MaximumDoseScheduleLeaf extends DoseScheduleBase {
...
export interface MeasurementTypeEnumerationLeaf extends EnumerationBase {
...
export interface MediaGalleryLeaf extends WebPageBase {
  "@type": "MediaGallery";
}
...
export interface MediaManipulationRatingEnumerationLeaf extends EnumerationBase {
...
export interface MediaObjectBase extends CreativeWorkBase {
...
export interface MediaObjectLeaf extends MediaObjectBase {
  "@type": "MediaObject";
}
...
export interface MediaReviewBase extends ReviewBase {
...
export interface MediaReviewLeaf extends MediaReviewBase {
  "@type": "MediaReview";
}
...
export interface MediaReviewItemBase extends CreativeWorkBase {
...
export interface MediaReviewItemLeaf extends MediaReviewItemBase {
...
export interface MediaSubscriptionBase extends ThingBase {
  /** The Organization responsible for authenticating the user's subscription. For example, many media apps require a cable/satellite provider to authenticate your subscription before playing media. */
  "authenticator"?: SchemaValue<Organization | IdReference, "authenticator">;
  /** An Offer which must be accepted before the user can perform the Action. For example, the user may need to buy a movie before being able to watch it. */
  "expectsAcceptanceOf"?: SchemaValue<Offer | IdReference, "expectsAcceptanceOf">;
}
export interface MediaSubscriptionLeaf extends MediaSubscriptionBase {
  "@type": "MediaSubscription";
}
/** A subscription which allows a user to access media including audio, video, books, etc. */
export declare type MediaSubscription = MediaSubscriptionLeaf;
export interface MedicalAudienceBase extends AudienceBase, PeopleAudienceBase {
}
export interface MedicalAudienceLeaf extends MedicalAudienceBase {
  "@type": "MedicalAudience";
}
/** Target audiences for medical web pages. */
export declare type MedicalAudience = MedicalAudienceLeaf | Patient;
export interface MedicalAudienceTypeLeaf extends EnumerationBase {
...
export interface MedicalBusinessLeaf extends LocalBusinessBase {
...
export interface MedicalClinicBase extends MedicalOrganizationBase, LocalBusinessBase {
  /** A medical service available from this provider. */
  "availableService"?: SchemaValue<MedicalProcedure | MedicalTest | MedicalTherapy | IdReference, "availableService">;
  /** A medical specialty of the provider. */
  "medicalSpecialty"?: SchemaValue<MedicalSpecialty | IdReference, "medicalSpecialty">;
}
export interface MedicalClinicLeaf extends MedicalClinicBase {
  "@type": "MedicalClinic";
}
...
export interface MedicalCodeBase extends CategoryCodeBase, MedicalEntityBase {
  /** A short textual code that uniquely identifies the value. */
  "codeValue"?: SchemaValue<Text, "codeValue">;
  /** The coding system, e.g. 'ICD-10'. */
  "codingSystem"?: SchemaValue<Text, "codingSystem">;
}
export interface MedicalCodeLeaf extends MedicalCodeBase {
  "@type": "MedicalCode";
}
/** A code for a medical entity. */
export declare type MedicalCode = MedicalCodeLeaf;
export interface MedicalConditionBase extends MedicalEntityBase {
...
export interface MedicalConditionLeaf extends MedicalConditionBase {
...
export interface MedicalConditionStageBase extends MedicalEntityBase {
  /** The stage represented as a number, e.g. 3. */
  "stageAsNumber"?: SchemaValue<Number, "stageAsNumber">;
  /** The substage, e.g. 'a' for Stage IIIa. */
  "subStageSuffix"?: SchemaValue<Text, "subStageSuffix">;
}
export interface MedicalConditionStageLeaf extends MedicalConditionStageBase {
  "@type": "MedicalConditionStage";
}
/** A stage of a medical condition, such as 'Stage IIIa'. */
export declare type MedicalConditionStage = MedicalConditionStageLeaf;
export interface MedicalContraindicationLeaf extends MedicalEntityBase {
...
export interface MedicalDeviceBase extends MedicalEntityBase {
...
export interface MedicalDeviceLeaf extends MedicalDeviceBase {
  "@type": "MedicalDevice";
}
/** Any object used in a medical capacity, such as to diagnose or treat a patient. */
export declare type MedicalDevice = MedicalDeviceLeaf;
export interface MedicalDevicePurposeLeaf extends EnumerationBase {
...
export interface MedicalEntityBase extends ThingBase {
...
export interface MedicalEntityLeaf extends MedicalEntityBase {
  "@type": "MedicalEntity";
}
...
export interface MedicalEnumerationLeaf extends EnumerationBase {
...
export interface MedicalEvidenceLevelLeaf extends EnumerationBase {
...
export interface MedicalGuidelineBase extends MedicalEntityBase {
...
export interface MedicalGuidelineLeaf extends MedicalGuidelineBase {
...
export interface MedicalGuidelineContraindicationLeaf extends MedicalGuidelineBase {
...
export interface MedicalGuidelineRecommendationBase extends MedicalGuidelineBase {
  /** Strength of the guideline's recommendation (e.g. 'class I'). */
  "recommendationStrength"?: SchemaValue<Text, "recommendationStrength">;
}
export interface MedicalGuidelineRecommendationLeaf extends MedicalGuidelineRecommendationBase {
...
export interface MedicalImagingTechniqueLeaf extends EnumerationBase {
...
export interface MedicalIndicationLeaf extends MedicalEntityBase {
...
export interface MedicalIntangibleLeaf extends MedicalEntityBase {
...
export interface MedicalObservationalStudyBase extends MedicalStudyBase {
  /** Specifics about the observational study design (enumerated). */
  "studyDesign"?: SchemaValue<MedicalObservationalStudyDesign | IdReference, "studyDesign">;
}
export interface MedicalObservationalStudyLeaf extends MedicalObservationalStudyBase {
...
export interface MedicalObservationalStudyDesignLeaf extends EnumerationBase {
...
export interface MedicalOrganizationBase extends OrganizationBase {
  /** Name or unique ID of network. (Networks are often reused across different insurance plans). */
  "healthPlanNetworkId"?: SchemaValue<Text, "healthPlanNetworkId">;
...
export interface MedicalOrganizationLeaf extends MedicalOrganizationBase {
...
export interface MedicalProcedureBase extends MedicalEntityBase {
  /** Location in the body of the anatomical structure. */
  "bodyLocation"?: SchemaValue<Text, "bodyLocation">;
...
export interface MedicalProcedureLeaf extends MedicalProcedureBase {
...
export interface MedicalProcedureTypeLeaf extends EnumerationBase {
...
export interface MedicalRiskCalculatorLeaf extends MedicalRiskEstimatorBase {
...
export interface MedicalRiskEstimatorBase extends MedicalEntityBase {
...
export interface MedicalRiskEstimatorLeaf extends MedicalRiskEstimatorBase {
...
export interface MedicalRiskFactorBase extends MedicalEntityBase {
  /** The condition, complication, etc. influenced by this factor. */
  "increasesRiskOf"?: SchemaValue<MedicalEntity | IdReference, "increasesRiskOf">;
}
export interface MedicalRiskFactorLeaf extends MedicalRiskFactorBase {
  "@type": "MedicalRiskFactor";
}
/** A risk factor is anything that increases a person's likelihood of developing or contracting a disease, medical condition, or complication. */
export declare type MedicalRiskFactor = MedicalRiskFactorLeaf;
export interface MedicalRiskScoreBase extends MedicalRiskEstimatorBase {
  /** The algorithm or rules to follow to compute the score. */
  "algorithm"?: SchemaValue<Text, "algorithm">;
}
export interface MedicalRiskScoreLeaf extends MedicalRiskScoreBase {
  "@type": "MedicalRiskScore";
}
/** A simple system that adds up the number of risk factors to yield a score that is associated with prognosis, e.g. CHAD score, TIMI risk score. */
export declare type MedicalRiskScore = MedicalRiskScoreLeaf;
export interface MedicalScholarlyArticleBase extends ArticleBase {
...
export interface MedicalScholarlyArticleLeaf extends MedicalScholarlyArticleBase {
  "@type": "MedicalScholarlyArticle";
}
/** A scholarly article in the medical domain. */
export declare type MedicalScholarlyArticle = MedicalScholarlyArticleLeaf;
export interface MedicalSignBase extends MedicalSignOrSymptomBase {
...
export interface MedicalSignLeaf extends MedicalSignBase {
  "@type": "MedicalSign";
}
/** Any physical manifestation of a person's medical condition discoverable by objective diagnostic tests or physical examination. */
export declare type MedicalSign = MedicalSignLeaf | VitalSign;
export interface MedicalSignOrSymptomBase extends MedicalConditionBase {
  /** A possible treatment to address this condition, sign or symptom. */
  "possibleTreatment"?: SchemaValue<MedicalTherapy | IdReference, "possibleTreatment">;
}
export interface MedicalSignOrSymptomLeaf extends MedicalSignOrSymptomBase {
...
export interface MedicalSpecialtyBase extends EnumerationBase, EnumerationBase {
}
export interface MedicalSpecialtyLeaf extends MedicalSpecialtyBase {
...
export interface MedicalStudyBase extends MedicalEntityBase {
...
export interface MedicalStudyLeaf extends MedicalStudyBase {
  "@type": "MedicalStudy";
}
...
export interface MedicalStudyStatusLeaf extends EnumerationBase {
...
export interface MedicalSymptomLeaf extends MedicalSignOrSymptomBase {
  "@type": "MedicalSymptom";
}
/** Any complaint sensed and expressed by the patient (therefore defined as subjective) like stomachache, lower-back pain, or fatigue. */
export declare type MedicalSymptom = MedicalSymptomLeaf;
export interface MedicalTestBase extends MedicalEntityBase {
...
export interface MedicalTherapyLeaf extends MedicalTherapyBase {
  "@type": "MedicalTherapy";
}
/** Any medical intervention designed to prevent, treat, and cure human diseases and medical conditions, including both curative and palliative therapies. Medical therapies are typically processes of care relying upon pharmacotherapy, behavioral therapy, supportive therapy (with fluid or nutrition for example), or detoxification (e.g. hemodialysis) aimed at improving or preventing a health condition. */
export declare type MedicalTherapy = MedicalTherapyLeaf | OccupationalTherapy | PalliativeProcedure | PhysicalTherapy | RadiationTherapy | RespiratoryTherapy;
export interface MedicalTrialBase extends MedicalStudyBase {
  /** Specifics about the trial design (enumerated). */
  "trialDesign"?: SchemaValue<MedicalTrialDesign | IdReference, "trialDesign">;
}
export interface MedicalTrialLeaf extends MedicalTrialBase {
  "@type": "MedicalTrial";
}
/** A medical trial is a type of medical study that uses scientific process used to compare the safety and efficacy of medical therapies or medical procedures. In general, medical trials are controlled and subjects are allocated at random to the different treatment and/or control groups. */
export declare type MedicalTrial = MedicalTrialLeaf;
export interface MedicalTrialDesignLeaf extends EnumerationBase {
...
export interface MedicalWebPageBase extends WebPageBase {
  /**
...
export interface MedicalWebPageLeaf extends MedicalWebPageBase {
  "@type": "MedicalWebPage";
}
/** A web page that provides medical information. */
export declare type MedicalWebPage = MedicalWebPageLeaf;
export interface MedicineSystemLeaf extends EnumerationBase {
  "@type": "MedicineSystem";
}
...
export interface MeetingRoomLeaf extends AccommodationBase {
  "@type": "MeetingRoom";
}
/**
...
export interface MensClothingStoreLeaf extends LocalBusinessBase {
  "@type": "MensClothingStore";
}
/** A men's clothing store. */
export declare type MensClothingStore = MensClothingStoreLeaf | string;
export interface MenuBase extends CreativeWorkBase {
...
export interface MenuLeaf extends MenuBase {
  "@type": "Menu";
}
/** A structured representation of food or drink items available from a FoodEstablishment. */
export declare type Menu = MenuLeaf;
export interface MenuItemBase extends ThingBase {
...
export interface MenuSectionBase extends CreativeWorkBase {
  /** A food or drink item contained in a menu or menu section. */
  "hasMenuItem"?: SchemaValue<MenuItem | IdReference, "hasMenuItem">;
  /** A subgrouping of the menu (by dishes, course, serving time period, etc.). */
  "hasMenuSection"?: SchemaValue<MenuSection | IdReference, "hasMenuSection">;
}
export interface MenuSectionLeaf extends MenuSectionBase {
  "@type": "MenuSection";
}
/** A sub-grouping of food or drink items in a menu. E.g. courses (such as 'Dinner', 'Breakfast', etc.), specific type of dishes (such as 'Meat', 'Vegan', 'Drinks', etc.), or some other classification made by the menu provider. */
export declare type MenuSection = MenuSectionLeaf;
export interface MerchantReturnEnumerationLeaf extends EnumerationBase {
...
export interface MerchantReturnPolicyBase extends ThingBase {
  /**
...
export interface MerchantReturnPolicyLeaf extends MerchantReturnPolicyBase {
...
export interface MerchantReturnPolicySeasonalOverrideBase extends ThingBase {
  /** The end date and time of the item (in {@link http://en.wikipedia.org/wiki/ISO_8601 ISO 8601 date format}). */
  "endDate"?: SchemaValue<Date | DateTime, "endDate">;
  /** Specifies either a fixed return date or the number of days (from the delivery date) that a product can be returned. Used when the {@link https://schema.org/returnPolicyCategory returnPolicyCategory} property is specified as {@link https://schema.org/MerchantReturnFiniteReturnWindow MerchantReturnFiniteReturnWindow}. */
  "merchantReturnDays"?: SchemaValue<Date | DateTime | Integer, "merchantReturnDays">;
...
export interface MerchantReturnPolicySeasonalOverrideLeaf extends MerchantReturnPolicySeasonalOverrideBase {
  "@type": "MerchantReturnPolicySeasonalOverride";
}
/** A seasonal override of a return policy, for example used for holidays. */
export declare type MerchantReturnPolicySeasonalOverride = MerchantReturnPolicySeasonalOverrideLeaf;
export interface MessageBase extends CreativeWorkBase {
...
export interface MessageLeaf extends MessageBase {
  "@type": "Message";
}
/** A single message from a sender to one or more organizations or people. */
export declare type Message = MessageLeaf | EmailMessage;
export interface MiddleSchoolLeaf extends EducationalOrganizationBase {
  "@type": "MiddleSchool";
}
/** A middle school (typically for children aged around 11-14, although this varies somewhat). */
export declare type MiddleSchool = MiddleSchoolLeaf | string;
export interface MidwiferyLeaf extends LocalBusinessBase {
  "@type": "Midwifery";
}
...
export declare type Midwifery = MidwiferyLeaf | string;
export interface MobileApplicationBase extends SoftwareApplicationBase {
  /** Specifies specific carrier(s) requirements for the application (e.g. an application may only work on a specific carrier network). */
  "carrierRequirements"?: SchemaValue<Text, "carrierRequirements">;
}
export interface MobileApplicationLeaf extends MobileApplicationBase {
  "@type": "MobileApplication";
}
/** A software application designed specifically to work well on a mobile device such as a telephone. */
export declare type MobileApplication = MobileApplicationLeaf;
export interface MobilePhoneStoreLeaf extends LocalBusinessBase {
  "@type": "MobilePhoneStore";
}
/** A store that sells mobile phones and related accessories. */
export declare type MobilePhoneStore = MobilePhoneStoreLeaf | string;
export interface MolecularEntityBase extends BioChemEntityBase {
  /** A role played by the BioChemEntity within a chemical context. */
  "chemicalRole"?: SchemaValue<DefinedTerm | IdReference, "chemicalRole">;
...
export interface MolecularEntityLeaf extends MolecularEntityBase {
  "@type": "MolecularEntity";
}
/** Any constitutionally or isotopically distinct atom, molecule, ion, ion pair, radical, radical ion, complex, conformer etc., identifiable as a separately distinguishable entity. */
export declare type MolecularEntity = MolecularEntityLeaf;
export interface MonetaryAmountBase extends ThingBase {
  /**
   * The currency in which the monetary amount is expressed.
   *
   * Use standard formats: {@link http://en.wikipedia.org/wiki/ISO_4217 ISO 4217 currency format} e.g. "USD"; {@link https://en.wikipedia.org/wiki/List_of_cryptocurrencies Ticker symbol} for cryptocurrencies e.g. "BTC"; well known names for {@link https://en.wikipedia.org/wiki/Local_exchange_trading_system Local Exchange Tradings Systems} (LETS) and other currency types e.g. "Ithaca HOUR".
...
export interface MonetaryAmountLeaf extends MonetaryAmountBase {
  "@type": "MonetaryAmount";
}
...
export interface MonetaryAmountDistributionBase extends QuantitativeValueDistributionBase {
  /**
   * The currency in which the monetary amount is expressed.
   *
   * Use standard formats: {@link http://en.wikipedia.org/wiki/ISO_4217 ISO 4217 currency format} e.g. "USD"; {@link https://en.wikipedia.org/wiki/List_of_cryptocurrencies Ticker symbol} for cryptocurrencies e.g. "BTC"; well known names for {@link https://en.wikipedia.org/wiki/Local_exchange_trading_system Local Exchange Tradings Systems} (LETS) and other currency types e.g. "Ithaca HOUR".
...
export interface MonetaryAmountDistributionLeaf extends MonetaryAmountDistributionBase {
  "@type": "MonetaryAmountDistribution";
}
/** A statistical distribution of monetary amounts. */
export declare type MonetaryAmountDistribution = MonetaryAmountDistributionLeaf;
export interface MonetaryGrantBase extends GrantBase {
  /** The amount of money. */
  "amount"?: SchemaValue<MonetaryAmount | Number | IdReference, "amount">;
  /** A person or organization that supports (sponsors) something through some kind of financial contribution. */
  "funder"?: SchemaValue<Organization | Person | IdReference, "funder">;
}
export interface MonetaryGrantLeaf extends MonetaryGrantBase {
  "@type": "MonetaryGrant";
}
/** A monetary grant. */
export declare type MonetaryGrant = MonetaryGrantLeaf;
export interface MoneyTransferBase extends TransferActionBase {
  /** The amount of money. */
  "amount"?: SchemaValue<MonetaryAmount | Number | IdReference, "amount">;
  /** A bank or bank’s branch, financial institution or international financial institution operating the beneficiary’s bank account or releasing funds for the beneficiary. */
  "beneficiaryBank"?: SchemaValue<BankOrCreditUnion | Text | IdReference, "beneficiaryBank">;
}
export interface MoneyTransferLeaf extends MoneyTransferBase {
  "@type": "MoneyTransfer";
}
/** The act of transferring money from one place to another place. This may occur electronically or physically. */
export declare type MoneyTransfer = MoneyTransferLeaf;
export interface MortgageLoanBase extends LoanOrCreditBase {
...
export interface MortgageLoanLeaf extends MortgageLoanBase {
  "@type": "MortgageLoan";
}
/** A loan in which property or real estate is used as collateral. (A loan securitized against some real estate). */
export declare type MortgageLoan = MortgageLoanLeaf;
export interface MosqueLeaf extends CivicStructureBase {
  "@type": "Mosque";
}
/** A mosque. */
export declare type Mosque = MosqueLeaf | string;
export interface MotelLeaf extends LodgingBusinessBase {
  "@type": "Motel";
}
/**
* A motel.
...
export interface MotorcycleLeaf extends VehicleBase {
  "@type": "Motorcycle";
}
/** A motorcycle or motorbike is a single-track, two-wheeled motor vehicle. */
export declare type Motorcycle = MotorcycleLeaf;
export interface MotorcycleDealerLeaf extends LocalBusinessBase {
  "@type": "MotorcycleDealer";
}
/** A motorcycle dealer. */
export declare type MotorcycleDealer = MotorcycleDealerLeaf | string;
export interface MotorcycleRepairLeaf extends LocalBusinessBase {
  "@type": "MotorcycleRepair";
}
/** A motorcycle repair shop. */
export declare type MotorcycleRepair = MotorcycleRepairLeaf | string;
export interface MotorizedBicycleLeaf extends VehicleBase {
  "@type": "MotorizedBicycle";
}
/** A motorized bicycle is a bicycle with an attached motor used to power the vehicle, or to assist with pedaling. */
export declare type MotorizedBicycle = MotorizedBicycleLeaf;
export interface MountainLeaf extends PlaceBase {
  "@type": "Mountain";
}
/** A mountain, like Mount Whitney or Mount Everest. */
export declare type Mountain = MountainLeaf | string;
export interface MoveActionBase extends ActionBase {
  /** A sub property of location. The original location of the object or the agent before the action. */
  "fromLocation"?: SchemaValue<Place | IdReference, "fromLocation">;
  /** A sub property of location. The final location of the object or the agent after the action. */
  "toLocation"?: SchemaValue<Place | IdReference, "toLocation">;
}
export interface MoveActionLeaf extends MoveActionBase {
  "@type": "MoveAction";
}
/**
...
export interface MovieBase extends CreativeWorkBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface MovieLeaf extends MovieBase {
  "@type": "Movie";
}
/** A movie. */
export declare type Movie = MovieLeaf;
export interface MovieClipLeaf extends ClipBase {
  "@type": "MovieClip";
}
/** A short segment/part of a movie. */
export declare type MovieClip = MovieClipLeaf;
export interface MovieRentalStoreLeaf extends LocalBusinessBase {
  "@type": "MovieRentalStore";
}
/** A movie rental store. */
export declare type MovieRentalStore = MovieRentalStoreLeaf | string;
export interface MovieSeriesBase extends CreativeWorkSeriesBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface MovieSeriesLeaf extends MovieSeriesBase {
  "@type": "MovieSeries";
}
/** A series of movies. Included movies can be indicated with the hasPart property. */
export declare type MovieSeries = MovieSeriesLeaf;
export interface MovieTheaterBase extends LocalBusinessBase, CivicStructureBase {
  /** The number of screens in the movie theater. */
  "screenCount"?: SchemaValue<Number, "screenCount">;
}
export interface MovieTheaterLeaf extends MovieTheaterBase {
  "@type": "MovieTheater";
}
/** A movie theater. */
export declare type MovieTheater = MovieTheaterLeaf | string;
export interface MovingCompanyLeaf extends LocalBusinessBase {
  "@type": "MovingCompany";
}
/** A moving company. */
export declare type MovingCompany = MovingCompanyLeaf | string;
export interface MuscleBase extends AnatomicalStructureBase {
...
export interface MuscleLeaf extends MuscleBase {
  "@type": "Muscle";
}
/** A muscle is an anatomical structure consisting of a contractile form of tissue that animals use to effect movement. */
export declare type Muscle = MuscleLeaf;
export interface MuseumLeaf extends CivicStructureBase {
  "@type": "Museum";
}
/** A museum. */
export declare type Museum = MuseumLeaf | string;
export interface MusicAlbumBase extends MusicPlaylistBase {
...
export interface MusicAlbumLeaf extends MusicAlbumBase {
  "@type": "MusicAlbum";
}
/** A collection of music tracks. */
export declare type MusicAlbum = MusicAlbumLeaf;
export interface MusicAlbumProductionTypeLeaf extends EnumerationBase {
...
export interface MusicAlbumReleaseTypeLeaf extends EnumerationBase {
...
export interface MusicCompositionBase extends CreativeWorkBase {
  /** The person or organization who wrote a composition, or who is the composer of a work performed at some event. */
  "composer"?: SchemaValue<Organization | Person | IdReference, "composer">;
...
export interface MusicCompositionLeaf extends MusicCompositionBase {
  "@type": "MusicComposition";
}
/** A musical composition. */
export declare type MusicComposition = MusicCompositionLeaf;
export interface MusicEventLeaf extends EventBase {
  "@type": "MusicEvent";
}
/** Event type: Music event. */
export declare type MusicEvent = MusicEventLeaf;
export interface MusicGroupBase extends OrganizationBase {
  /** A music album. */
...
export interface MusicGroupLeaf extends MusicGroupBase {
  "@type": "MusicGroup";
}
/** A musical group, such as a band, an orchestra, or a choir. Can also be a solo musician. */
export declare type MusicGroup = MusicGroupLeaf | string;
export interface MusicPlaylistBase extends CreativeWorkBase {
...
export interface MusicPlaylistLeaf extends MusicPlaylistBase {
  "@type": "MusicPlaylist";
}
/** A collection of music tracks in playlist form. */
export declare type MusicPlaylist = MusicPlaylistLeaf | MusicAlbum | MusicRelease;
export interface MusicRecordingBase extends CreativeWorkBase {
  /** The artist that performed this album or recording. */
  "byArtist"?: SchemaValue<MusicGroup | Person | IdReference, "byArtist">;
  /** The duration of the item (movie, audio recording, event, etc.) in {@link http://en.wikipedia.org/wiki/ISO_8601 ISO 8601 date format}. */
  "duration"?: SchemaValue<Duration | IdReference, "duration">;
...
export interface MusicRecordingLeaf extends MusicRecordingBase {
  "@type": "MusicRecording";
}
/** A music recording (track), usually a single song. */
export declare type MusicRecording = MusicRecordingLeaf;
export interface MusicReleaseBase extends MusicPlaylistBase {
...
export interface MusicReleaseLeaf extends MusicReleaseBase {
  "@type": "MusicRelease";
}
/** A MusicRelease is a specific release of a music album. */
export declare type MusicRelease = MusicReleaseLeaf;
export interface MusicReleaseFormatTypeLeaf extends EnumerationBase {
...
export interface MusicStoreLeaf extends LocalBusinessBase {
  "@type": "MusicStore";
}
/** A music store. */
export declare type MusicStore = MusicStoreLeaf | string;
export interface MusicVenueLeaf extends CivicStructureBase {
  "@type": "MusicVenue";
}
/** A music venue. */
export declare type MusicVenue = MusicVenueLeaf | string;
export interface MusicVideoObjectLeaf extends MediaObjectBase {
  "@type": "MusicVideoObject";
}
/** A music video file. */
export declare type MusicVideoObject = MusicVideoObjectLeaf;
export interface NailSalonLeaf extends LocalBusinessBase {
  "@type": "NailSalon";
}
/** A nail salon. */
export declare type NailSalon = NailSalonLeaf | string;
export interface NerveBase extends AnatomicalStructureBase {
  /**
...
export interface NerveLeaf extends NerveBase {
  "@type": "Nerve";
}
/** A common pathway for the electrochemical nerve impulses that are transmitted along each of the axons. */
export declare type Nerve = NerveLeaf;
export interface NewsArticleBase extends ArticleBase {
  /**
...
export interface NewsArticleLeaf extends NewsArticleBase {
  "@type": "NewsArticle";
}
/**
...
export interface NewsMediaOrganizationBase extends OrganizationBase {
...
export interface NewsMediaOrganizationLeaf extends NewsMediaOrganizationBase {
  "@type": "NewsMediaOrganization";
}
/** A News/Media organization such as a newspaper or TV station. */
export declare type NewsMediaOrganization = NewsMediaOrganizationLeaf | string;
export interface NewspaperLeaf extends CreativeWorkSeriesBase {
  "@type": "Newspaper";
}
/** A publication containing information about varied topics that are pertinent to general information, a geographic area, or a specific subject matter (i.e. business, culture, education). Often published daily. */
export declare type Newspaper = NewspaperLeaf;
export interface NGOLeaf extends OrganizationBase {
  "@type": "NGO";
}
/** Organization: Non-governmental Organization. */
export declare type NGO = NGOLeaf | string;
export interface NightClubLeaf extends LocalBusinessBase {
  "@type": "NightClub";
}
/** A nightclub or discotheque. */
export declare type NightClub = NightClubLeaf | string;
export interface NLNonprofitTypeLeaf extends EnumerationBase {
...
export interface NutritionInformationLeaf extends NutritionInformationBase {
  "@type": "NutritionInformation";
}
/** Nutritional information about the recipe. */
export declare type NutritionInformation = NutritionInformationLeaf;
export interface ObservationBase extends ThingBase {
  ...
  "measuredValue"?: SchemaValue<DataType | IdReference, "measuredValue">;
  ...
  "observedNode"?: SchemaValue<StatisticalPopulation | IdReference, "observedNode">;
}
export interface ObservationLeaf extends ObservationBase {
  "@type": "Observation";
}
...
export interface ObstetricLeaf extends LocalBusinessBase {
  "@type": "Obstetric";
}
...
export declare type Obstetric = ObstetricLeaf | string;
export interface OccupationBase extends ThingBase {
  /** Educational background needed for the position or Occupation. */
  "educationRequirements"?: SchemaValue<EducationalOccupationalCredential | Text | IdReference, "educationRequirements">;
  /** An estimated salary for a job posting or occupation, based on a variety of variables including, but not limited to industry, job title, and location. Estimated salaries are often computed by outside organizations rather than the hiring organization, who may not have committed to the estimated value. */
  "estimatedSalary"?: SchemaValue<MonetaryAmount | MonetaryAmountDistribution | Number | IdReference, "estimatedSalary">;
...
export interface OccupationLeaf extends OccupationBase {
  "@type": "Occupation";
}
/** A profession, may involve prolonged training and/or a formal qualification. */
export declare type Occupation = OccupationLeaf;
export interface OccupationalExperienceRequirementsBase extends ThingBase {
  /** Indicates the minimal number of months of experience required for a position. */
  "monthsOfExperience"?: SchemaValue<Number, "monthsOfExperience">;
}
export interface OccupationalExperienceRequirementsLeaf extends OccupationalExperienceRequirementsBase {
...
export interface OfferLeaf extends OfferBase {
  "@type": "Offer";
}
/**
...
export interface OfferCatalogLeaf extends ItemListBase {
  "@type": "OfferCatalog";
}
/** An OfferCatalog is an ItemList that contains related Offers and/or further OfferCatalogs that are offeredBy the same provider. */
export declare type OfferCatalog = OfferCatalogLeaf;
export interface OfferForLeaseLeaf extends OfferBase {
  "@type": "OfferForLease";
}
...
export interface OfferForPurchaseLeaf extends OfferBase {
...
export interface OfferItemConditionLeaf extends EnumerationBase {
...
export interface OfferShippingDetailsBase extends ThingBase {
  /** The total delay between the receipt of the order and the goods reaching the final customer. */
  "deliveryTime"?: SchemaValue<ShippingDeliveryTime | IdReference, "deliveryTime">;
...
export interface OfferShippingDetailsLeaf extends OfferShippingDetailsBase {
...
export interface OfficeEquipmentStoreLeaf extends LocalBusinessBase {
  "@type": "OfficeEquipmentStore";
}
/** An office equipment store. */
export declare type OfficeEquipmentStore = OfficeEquipmentStoreLeaf | string;
export interface OncologicLeaf extends LocalBusinessBase {
  "@type": "Oncologic";
}
...
export declare type Oncologic = OncologicLeaf | string;
export interface OnDemandEventLeaf extends PublicationEventBase {
  "@type": "OnDemandEvent";
}
/** A publication event e.g. catch-up TV or radio podcast, during which a program is available on-demand. */
export declare type OnDemandEvent = OnDemandEventLeaf;
export interface OpeningHoursSpecificationBase extends ThingBase {
...
export interface OpeningHoursSpecificationLeaf extends OpeningHoursSpecificationBase {
...
export interface OpinionNewsArticleLeaf extends NewsArticleBase {
...
export interface OpticianLeaf extends LocalBusinessBase {
  "@type": "Optician";
}
/** A store that sells reading glasses and similar devices for improving vision. */
export declare type Optician = OpticianLeaf | string;
export interface OptometricLeaf extends LocalBusinessBase {
  "@type": "Optometric";
}
/** The science or practice of testing visual acuity and prescribing corrective lenses. */
export declare type Optometric = OptometricLeaf | string;
export interface OrderBase extends ThingBase {
...
export interface OrderLeaf extends OrderBase {
  "@type": "Order";
}
/** An order is a confirmation of a transaction (a receipt), which can contain multiple line items, each represented by an Offer that has been accepted by the customer. */
export declare type Order = OrderLeaf;
export interface OrderActionBase extends TradeActionBase {
  /** A sub property of instrument. The method of delivery. */
  "deliveryMethod"?: SchemaValue<DeliveryMethod | IdReference, "deliveryMethod">;
}
export interface OrderActionLeaf extends OrderActionBase {
  "@type": "OrderAction";
}
/** An agent orders an object/product/service to be delivered/sent. */
export declare type OrderAction = OrderActionLeaf;
export interface OrderItemBase extends ThingBase {
  /** The delivery of the parcel related to this order or order item. */
  "orderDelivery"?: SchemaValue<ParcelDelivery | IdReference, "orderDelivery">;
  /** The item ordered. */
  "orderedItem"?: SchemaValue<OrderItem | Product | Service | IdReference, "orderedItem">;
...
export interface OrderItemLeaf extends OrderItemBase {
  "@type": "OrderItem";
}
/** An order item is a line of an order. It includes the quantity and shipping details of a bought offer. */
export declare type OrderItem = OrderItemLeaf;
export interface OrderStatusLeaf extends EnumerationBase {
  "@type": "OrderStatus";
}
...
export interface OrganizationBase extends ThingBase {
  /** For a {@link https://schema.org/NewsMediaOrganization NewsMediaOrganization} or other news-related {@link https://schema.org/Organization Organization}, a statement about public engagement activities (for news media, the newsroom’s), including involving the public - digitally or otherwise -- in coverage decisions, reporting and activities after publication. */
  "actionableFeedbackPolicy"?: SchemaValue<CreativeWork | URL | IdReference, "actionableFeedbackPolicy">;
  /** Physical address of the item. */
  "address"?: SchemaValue<PostalAddress | Text | IdReference, "address">;
  ...
  "memberOf"?: SchemaValue<Organization | ProgramMembership | IdReference, "memberOf">;
  /**
...
export interface OrganizeActionLeaf extends ActionBase {
  "@type": "OrganizeAction";
}
...
export interface OtolaryngologicLeaf extends LocalBusinessBase {
...
export declare type Otolaryngologic = OtolaryngologicLeaf | string;
export interface OutletStoreLeaf extends LocalBusinessBase {
  "@type": "OutletStore";
}
/** An outlet store. */
export declare type OutletStore = OutletStoreLeaf | string;
export interface OwnershipInfoBase extends ThingBase {
...
export interface OwnershipInfoLeaf extends OwnershipInfoBase {
  "@type": "OwnershipInfo";
}
/** A structured value providing information about when a certain organization or person owned a certain product. */
export declare type OwnershipInfo = OwnershipInfoLeaf;
export interface PaintActionLeaf extends ActionBase {
  "@type": "PaintAction";
}
/** The act of producing a painting, typically with paint and canvas as instruments. */
export declare type PaintAction = PaintActionLeaf;
export interface PaintingLeaf extends CreativeWorkBase {
  "@type": "Painting";
}
/** A painting. */
export declare type Painting = PaintingLeaf;
export interface PalliativeProcedureBase extends MedicalTherapyBase, MedicalProcedureBase {
}
export interface PalliativeProcedureLeaf extends PalliativeProcedureBase {
  "@type": "PalliativeProcedure";
}
/** A medical procedure intended primarily for palliative purposes, aimed at relieving the symptoms of an underlying health condition. */
export declare type PalliativeProcedure = PalliativeProcedureLeaf;
export interface ParcelDeliveryBase extends ThingBase {
  /**
   * 'carrier' is an out-dated term indicating the 'provider' for parcel delivery and flights.
   *
   * @deprecated Consider using https://schema.org/provider instead.
...
export interface ParcelDeliveryLeaf extends ParcelDeliveryBase {
  "@type": "ParcelDelivery";
}
/** The delivery of a parcel either via the postal service or a commercial service. */
export declare type ParcelDelivery = ParcelDeliveryLeaf;
export interface ParentAudienceBase extends PeopleAudienceBase {
  /** Maximal age of the child. */
  "childMaxAge"?: SchemaValue<Number, "childMaxAge">;
  /** Minimal age of the child. */
  "childMinAge"?: SchemaValue<Number, "childMinAge">;
}
export interface ParentAudienceLeaf extends ParentAudienceBase {
  "@type": "ParentAudience";
}
/** A set of characteristics describing parents, who can be interested in viewing some content. */
export declare type ParentAudience = ParentAudienceLeaf;
export interface ParkLeaf extends CivicStructureBase {
  "@type": "Park";
}
/** A park. */
export declare type Park = ParkLeaf | string;
export interface ParkingFacilityLeaf extends CivicStructureBase {
  "@type": "ParkingFacility";
}
/** A parking lot or other parking facility. */
export declare type ParkingFacility = ParkingFacilityLeaf | string;
export interface PathologyTestBase extends MedicalTestBase {
  /** The type of tissue sample required for the test. */
  "tissueSample"?: SchemaValue<Text, "tissueSample">;
}
export interface PathologyTestLeaf extends PathologyTestBase {
  "@type": "PathologyTest";
}
/** A medical test performed by a laboratory that typically involves examination of a tissue sample by a pathologist. */
export declare type PathologyTest = PathologyTestLeaf;
export interface PatientBase extends MedicalAudienceBase, PersonBase {
  /** One or more alternative conditions considered in the differential diagnosis process as output of a diagnosis process. */
  "diagnosis"?: SchemaValue<MedicalCondition | IdReference, "diagnosis">;
  /** Specifying a drug or medicine used in a medication procedure. */
  "drug"?: SchemaValue<Drug | IdReference, "drug">;
...
export interface PatientLeaf extends PatientBase {
  "@type": "Patient";
}
/** A patient is any person recipient of health care services. */
export declare type Patient = PatientLeaf | string;
export interface PawnShopLeaf extends LocalBusinessBase {
  "@type": "PawnShop";
}
/** A shop that will buy, or lend money against the security of, personal possessions. */
export declare type PawnShop = PawnShopLeaf | string;
export interface PayActionBase extends TradeActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface PayActionLeaf extends PayActionBase {
  "@type": "PayAction";
}
/** An agent pays a price to a participant. */
export declare type PayAction = PayActionLeaf;
export interface PaymentCardBase extends FinancialProductBase, EnumerationBase {
...
export interface PaymentCardLeaf extends PaymentCardBase {
  "@type": "PaymentCard";
}
/** A payment method using a credit, debit, store or other card to associate the payment with an account. */
export declare type PaymentCard = PaymentCardLeaf | CreditCard;
export interface PaymentChargeSpecificationBase extends PriceSpecificationBase {
  /** The delivery method(s) to which the delivery charge or payment charge specification applies. */
  "appliesToDeliveryMethod"?: SchemaValue<DeliveryMethod | IdReference, "appliesToDeliveryMethod">;
  /** The payment method(s) to which the payment charge specification applies. */
  "appliesToPaymentMethod"?: SchemaValue<PaymentMethod | IdReference, "appliesToPaymentMethod">;
}
export interface PaymentChargeSpecificationLeaf extends PaymentChargeSpecificationBase {
  "@type": "PaymentChargeSpecification";
}
/** The costs of settling the payment using a particular payment method. */
export declare type PaymentChargeSpecification = PaymentChargeSpecificationLeaf;
export interface PaymentMethodLeaf extends EnumerationBase {
  "@type": "PaymentMethod";
}
/**
...
export interface PaymentServiceLeaf extends FinancialProductBase {
  "@type": "PaymentService";
}
/** A Service to transfer funds from a person or organization to a beneficiary person or organization. */
export declare type PaymentService = PaymentServiceLeaf;
export interface PaymentStatusTypeLeaf extends EnumerationBase {
...
export interface PediatricLeaf extends LocalBusinessBase {
  "@type": "Pediatric";
}
/** A specific branch of medical science that specializes in the care of infants, children and adolescents. */
export declare type Pediatric = PediatricLeaf | string;
export interface PeopleAudienceBase extends AudienceBase {
  /** Specifying the health condition(s) of a patient, medical study, or other target audience. */
  "healthCondition"?: SchemaValue<MedicalCondition | IdReference, "healthCondition">;
...
export interface PermitBase extends ThingBase {
...
export interface PermitLeaf extends PermitBase {
  "@type": "Permit";
}
/** A permit issued by an organization, e.g. a parking pass. */
export declare type Permit = PermitLeaf | GovernmentPermit;
export interface PersonBase extends ThingBase {
...
export interface PetStoreLeaf extends LocalBusinessBase {
  "@type": "PetStore";
}
/** A pet store. */
export declare type PetStore = PetStoreLeaf | string;
export interface PharmacyBase extends MedicalOrganizationBase, LocalBusinessBase {
}
export interface PharmacyLeaf extends PharmacyBase {
  "@type": "Pharmacy";
}
/** A pharmacy or drugstore. */
export declare type Pharmacy = PharmacyLeaf | string;
export interface PhotographLeaf extends CreativeWorkBase {
  "@type": "Photograph";
}
/** A photograph. */
export declare type Photograph = PhotographLeaf;
export interface PhotographActionLeaf extends ActionBase {
  "@type": "PhotographAction";
}
/** The act of capturing still images of objects using a camera. */
export declare type PhotographAction = PhotographActionLeaf;
export interface PhysicalActivityBase extends MedicalEntityBase {
  /** The anatomy of the underlying organ system or structures associated with this entity. */
  "associatedAnatomy"?: SchemaValue<AnatomicalStructure | AnatomicalSystem | SuperficialAnatomy | IdReference, "associatedAnatomy">;
  /** A category for the item. Greater signs or slashes can be used to informally indicate a category hierarchy. */
  "category"?: SchemaValue<PhysicalActivityCategory | Text | Thing | URL | IdReference, "category">;
...
export interface PhysicalActivityLeaf extends PhysicalActivityBase {
...
export interface PhysicalActivityCategoryLeaf extends EnumerationBase {
...
export interface PhysicalExamBase extends EnumerationBase, MedicalProcedureBase {
}
export interface PhysicalExamLeaf extends PhysicalExamBase {
  "@type": "PhysicalExam";
}
...
export interface PhysicalTherapyLeaf extends MedicalTherapyBase {
  "@type": "PhysicalTherapy";
}
/** A process of progressive physical care and rehabilitation aimed at improving a health condition. */
export declare type PhysicalTherapy = PhysicalTherapyLeaf;
export interface PhysicianBase extends MedicalOrganizationBase, LocalBusinessBase {
  /** A medical service available from this provider. */
  "availableService"?: SchemaValue<MedicalProcedure | MedicalTest | MedicalTherapy | IdReference, "availableService">;
...
export interface PhysicianLeaf extends PhysicianBase {
  "@type": "Physician";
}
/** A doctor's office. */
export declare type Physician = PhysicianLeaf | string;
export interface PhysiotherapyLeaf extends LocalBusinessBase {
  "@type": "Physiotherapy";
}
...
export declare type Physiotherapy = PhysiotherapyLeaf | string;
export interface PlaceBase extends ThingBase {
  /**
   * A property-value pair representing an additional characteristics of the entitity, e.g. a product feature or another characteristic for which there is no matching property in schema.org.
   *
   * Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. https://schema.org/width, https://schema.org/color, https://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
...
export interface PlaceOfWorshipLeaf extends CivicStructureBase {
  "@type": "PlaceOfWorship";
}
...
export interface PlanActionBase extends ActionBase {
  /** The time the object is scheduled to. */
  "scheduledTime"?: SchemaValue<DateTime, "scheduledTime">;
}
export interface PlanActionLeaf extends PlanActionBase {
  "@type": "PlanAction";
}
/** The act of planning the execution of an event/task/action/reservation/plan to a future date. */
export declare type PlanAction = PlanActionLeaf | CancelAction | ReserveAction | ScheduleAction;
export interface PlasticSurgeryLeaf extends LocalBusinessBase {
  "@type": "PlasticSurgery";
}
...
export declare type PlasticSurgery = PlasticSurgeryLeaf | string;
export interface PlayLeaf extends CreativeWorkBase {
  "@type": "Play";
}
...
export interface PlayActionBase extends ActionBase {
  /** An intended audience, i.e. a group for whom something was created. */
  "audience"?: SchemaValue<Audience | IdReference, "audience">;
  /** Upcoming or past event associated with this place, organization, or action. */
  "event"?: SchemaValue<Event | IdReference, "event">;
}
export interface PlayActionLeaf extends PlayActionBase {
  "@type": "PlayAction";
}
/**
...
export interface PlaygroundLeaf extends CivicStructureBase {
  "@type": "Playground";
}
/** A playground. */
export declare type Playground = PlaygroundLeaf | string;
export interface PlumberLeaf extends LocalBusinessBase {
  "@type": "Plumber";
}
/** A plumbing service. */
export declare type Plumber = PlumberLeaf | string;
export interface PodcastEpisodeLeaf extends EpisodeBase {
  "@type": "PodcastEpisode";
}
/** A single episode of a podcast series. */
export declare type PodcastEpisode = PodcastEpisodeLeaf;
export interface PodcastSeasonLeaf extends CreativeWorkSeasonBase {
  "@type": "PodcastSeason";
}
/** A single season of a podcast. Many podcasts do not break down into separate seasons. In that case, PodcastSeries should be used. */
export declare type PodcastSeason = PodcastSeasonLeaf;
export interface PodcastSeriesBase extends CreativeWorkSeriesBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /** The URL for a feed, e.g. associated with a podcast series, blog, or series of date-stamped updates. This is usually RSS or Atom. */
  "webFeed"?: SchemaValue<DataFeed | URL | IdReference, "webFeed">;
}
export interface PodcastSeriesLeaf extends PodcastSeriesBase {
  "@type": "PodcastSeries";
}
/** A podcast is an episodic series of digital audio or video files which a user can download and listen to. */
export declare type PodcastSeries = PodcastSeriesLeaf;
export interface PodiatricLeaf extends LocalBusinessBase {
  "@type": "Podiatric";
}
/** Podiatry is the care of the human foot, especially the diagnosis and treatment of foot disorders. */
export declare type Podiatric = PodiatricLeaf | string;
export interface PoliceStationBase extends CivicStructureBase, LocalBusinessBase {
}
export interface PoliceStationLeaf extends PoliceStationBase {
  "@type": "PoliceStation";
}
/** A police station. */
export declare type PoliceStation = PoliceStationLeaf | string;
export interface PondLeaf extends PlaceBase {
  "@type": "Pond";
}
/** A pond. */
export declare type Pond = PondLeaf | string;
export interface PostalAddressBase extends ContactPointBase {
  /** The country. For example, USA. You can also provide the two-letter {@link http://en.wikipedia.org/wiki/ISO_3166-1 ISO 3166-1 alpha-2 country code}. */
  "addressCountry"?: SchemaValue<Country | Text | IdReference, "addressCountry">;
...
export interface PostalAddressLeaf extends PostalAddressBase {
  "@type": "PostalAddress";
}
/** The mailing address. */
export declare type PostalAddress = PostalAddressLeaf;
export interface PostalCodeRangeSpecificationBase extends ThingBase {
...
export interface PostalCodeRangeSpecificationLeaf extends PostalCodeRangeSpecificationBase {
...
export interface PosterLeaf extends CreativeWorkBase {
  "@type": "Poster";
}
/** A large, usually printed placard, bill, or announcement, often illustrated, that is posted to advertise or publicize something. */
export declare type Poster = PosterLeaf;
export interface PostOfficeLeaf extends LocalBusinessBase {
  "@type": "PostOffice";
}
/** A post office. */
export declare type PostOffice = PostOfficeLeaf | string;
export interface PreOrderActionLeaf extends TradeActionBase {
  "@type": "PreOrderAction";
}
/** An agent orders a (not yet released) object/product/service to be delivered/sent. */
export declare type PreOrderAction = PreOrderActionLeaf;
export interface PrependActionLeaf extends InsertActionBase {
  "@type": "PrependAction";
}
/** The act of inserting at the beginning if an ordered collection. */
export declare type PrependAction = PrependActionLeaf;
export interface PreschoolLeaf extends EducationalOrganizationBase {
  "@type": "Preschool";
}
/** A preschool. */
export declare type Preschool = PreschoolLeaf | string;
export interface PresentationDigitalDocumentLeaf extends DigitalDocumentBase {
  "@type": "PresentationDigitalDocument";
}
/** A file containing slides or used for a presentation. */
export declare type PresentationDigitalDocument = PresentationDigitalDocumentLeaf;
export interface PreventionIndicationLeaf extends MedicalEntityBase {
  "@type": "PreventionIndication";
}
/** An indication for preventing an underlying condition, symptom, etc. */
export declare type PreventionIndication = PreventionIndicationLeaf;
export interface PriceComponentTypeEnumerationLeaf extends EnumerationBase {
...
export interface PriceSpecificationBase extends ThingBase {
  /** The interval and unit of measurement of ordering quantities for which the offer or price specification is valid. This allows e.g. specifying that a certain freight charge is valid only for a certain quantity. */
  "eligibleQuantity"?: SchemaValue<QuantitativeValue | IdReference, "eligibleQuantity">;
  /** The transaction volume, in a monetary unit, for which the offer or price specification is valid, e.g. for indicating a minimal purchasing volume, to express free shipping above a certain order volume, or to limit the acceptance of credit cards to purchases to a certain minimal amount. */
  "eligibleTransactionVolume"?: SchemaValue<PriceSpecification | IdReference, "eligibleTransactionVolume">;
...
export interface PriceSpecificationLeaf extends PriceSpecificationBase {
...
export interface PriceTypeEnumerationLeaf extends EnumerationBase {
...
export interface PrimaryCareLeaf extends LocalBusinessBase {
  "@type": "PrimaryCare";
}
...
export declare type PrimaryCare = PrimaryCareLeaf | string;
export interface ProductBase extends ThingBase {
  /**
   * A property-value pair representing an additional characteristics of the entitity, e.g. a product feature or another characteristic for which there is no matching property in schema.org.
   *
   * Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. https://schema.org/width, https://schema.org/color, https://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
...
export interface ProductLeaf extends ProductBase {
  "@type": "Product";
}
...
export interface ProductCollectionBase extends CollectionBase, ProductBase {
  /** This links to a node or nodes indicating the exact quantity of the products included in an {@link https://schema.org/Offer Offer} or {@link https://schema.org/ProductCollection ProductCollection}. */
  "includesObject"?: SchemaValue<TypeAndQuantityNode | IdReference, "includesObject">;
}
export interface ProductCollectionLeaf extends ProductCollectionBase {
...
export interface ProductGroupBase extends ProductBase {
...
export interface ProductGroupLeaf extends ProductGroupBase {
  "@type": "ProductGroup";
}
/**
...
export interface ProductModelLeaf extends ProductModelBase {
  "@type": "ProductModel";
}
/** A datasheet or vendor specification of a product (in the sense of a prototypical description). */
export declare type ProductModel = ProductModelLeaf;
export interface ProfessionalServiceLeaf extends LocalBusinessBase {
...
export interface ProfilePageLeaf extends WebPageBase {
  "@type": "ProfilePage";
}
/** Web page type: Profile page. */
export declare type ProfilePage = ProfilePageLeaf;
export interface ProgramMembershipBase extends ThingBase {
...
export interface ProgramMembershipLeaf extends ProgramMembershipBase {
  "@type": "ProgramMembership";
}
/** Used to describe membership in a loyalty programs (e.g. "StarAliance"), traveler clubs (e.g. "AAA"), purchase clubs ("Safeway Club"), etc. */
export declare type ProgramMembership = ProgramMembershipLeaf;
export interface ProjectLeaf extends OrganizationBase {
  "@type": "Project";
}
...
export interface PronounceableTextBase extends Partial<IdReference> {
  /** The language of the content or performance or used in an action. Please use one of the language codes from the {@link http://tools.ietf.org/html/bcp47 IETF BCP 47 standard}. See also {@link https://schema.org/availableLanguage availableLanguage}. */
  "inLanguage"?: SchemaValue<Language | Text | IdReference, "inLanguage">;
...
export interface PropertyBase extends ThingBase {
...
export interface PropertyLeaf extends PropertyBase {
  "@type": "Property";
}
/** A property, used to indicate attributes and relationships of some Thing; equivalent to rdf:Property. */
export declare type Property = PropertyLeaf;
export interface PropertyValueBase extends ThingBase {
  /** The upper value of some characteristic or property. */
  "maxValue"?: SchemaValue<Number, "maxValue">;
  /**
   * A technique or technology used in a {@link https://schema.org/Dataset Dataset} (or {@link https://schema.org/DataDownload DataDownload}, {@link https://schema.org/DataCatalog DataCatalog}), corresponding to the method used for measuring the corresponding variable(s) (described using {@link https://schema.org/variableMeasured variableMeasured}). This is oriented towards scientific and scholarly dataset publication but may have broader applicability; it is not intended as a full representation of measurement, but rather as a high level summary for dataset discovery.
...
export interface PropertyValueSpecificationBase extends ThingBase {
...
export interface PropertyValueSpecificationLeaf extends PropertyValueSpecificationBase {
  "@type": "PropertyValueSpecification";
}
/** A Property value specification. */
export declare type PropertyValueSpecification = PropertyValueSpecificationLeaf;
export interface ProteinBase extends BioChemEntityBase {
  /** A symbolic representation of a BioChemEnity. For example, a nucleotide sequence of a Gene or an amino acid sequence of a Protein. */
  "hasBioPolymerSequence"?: SchemaValue<Text, "hasBioPolymerSequence">;
}
export interface ProteinLeaf extends ProteinBase {
  "@type": "Protein";
}
...
export interface PsychiatricLeaf extends LocalBusinessBase {
  "@type": "Psychiatric";
}
...
export declare type Psychiatric = PsychiatricLeaf | string;
export interface PsychologicalTreatmentLeaf extends TherapeuticProcedureBase {
  "@type": "PsychologicalTreatment";
}
/** A process of care relying upon counseling, dialogue and communication aimed at improving a mental health condition without use of drugs. */
export declare type PsychologicalTreatment = PsychologicalTreatmentLeaf;
export interface PublicationEventBase extends EventBase {
  /**
   * A flag to signal that the item, event, or place is accessible for free.
   *
...
export interface PublicationEventLeaf extends PublicationEventBase {
...
export interface PublicationIssueBase extends CreativeWorkBase {
...
export interface PublicationIssueLeaf extends PublicationIssueBase {
...
export interface PublicationVolumeBase extends CreativeWorkBase {
  /** The page on which the work ends; for example "138" or "xvi". */
  "pageEnd"?: SchemaValue<Integer | Text, "pageEnd">;
  /** The page on which the work starts; for example "135" or "xiii". */
  "pageStart"?: SchemaValue<Integer | Text, "pageStart">;
...
export interface PublicationVolumeLeaf extends PublicationVolumeBase {
...
export interface PublicHealthLeaf extends LocalBusinessBase {
  "@type": "PublicHealth";
}
...
export declare type PublicHealth = PublicHealthLeaf | string;
export interface PublicSwimmingPoolLeaf extends LocalBusinessBase {
  "@type": "PublicSwimmingPool";
}
/** A public swimming pool. */
export declare type PublicSwimmingPool = PublicSwimmingPoolLeaf | string;
export interface PublicToiletLeaf extends CivicStructureBase {
  "@type": "PublicToilet";
}
/** A public toilet is a room or small building containing one or more toilets (and possibly also urinals) which is available for use by the general public, or by customers or employees of certain businesses. */
export declare type PublicToilet = PublicToiletLeaf | string;
export interface QAPageLeaf extends WebPageBase {
  "@type": "QAPage";
}
/** A QAPage is a WebPage focussed on a specific Question and its Answer(s), e.g. in a question answering site or documenting Frequently Asked Questions (FAQs). */
export declare type QAPage = QAPageLeaf;
export interface QualitativeValueBase extends EnumerationBase {
  /**
   * A property-value pair representing an additional characteristics of the entitity, e.g. a product feature or another characteristic for which there is no matching property in schema.org.
   *
   * Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. https://schema.org/width, https://schema.org/color, https://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
...
export interface QualitativeValueLeaf extends QualitativeValueBase {
...
export interface QuantitativeValueBase extends ThingBase {
  /**
   * A property-value pair representing an additional characteristics of the entitity, e.g. a product feature or another characteristic for which there is no matching property in schema.org.
   *
   * Note: Publishers should be aware that applications designed to use specific schema.org properties (e.g. https://schema.org/width, https://schema.org/color, https://schema.org/gtin13, ...) will typically expect such data to be provided using those properties, rather than using the generic property/value mechanism.
...
export interface QuantitativeValueLeaf extends QuantitativeValueBase {
  "@type": "QuantitativeValue";
}
/** A point value or interval for product characteristics and other purposes. */
export declare type QuantitativeValue = QuantitativeValueLeaf;
export interface QuantitativeValueDistributionBase extends ThingBase {
  /** The duration of the item (movie, audio recording, event, etc.) in {@link http://en.wikipedia.org/wiki/ISO_8601 ISO 8601 date format}. */
  "duration"?: SchemaValue<Duration | IdReference, "duration">;
  /** The median value. */
...
export interface QuantitativeValueDistributionLeaf extends QuantitativeValueDistributionBase {
...
export interface QuestionBase extends CommentBase {
...
export interface QuestionLeaf extends QuestionBase {
  "@type": "Question";
}
/** A specific question - e.g. from a user seeking answers online, or collected in a Frequently Asked Questions (FAQ) document. */
export declare type Question = QuestionLeaf;
export interface QuizLeaf extends LearningResourceBase {
  "@type": "Quiz";
}
/** Quiz: A test of knowledge, skills and abilities. */
export declare type Quiz = QuizLeaf;
export interface QuotationBase extends CreativeWorkBase {
  /** The (e.g. fictional) character, Person or Organization to whom the quotation is attributed within the containing CreativeWork. */
  "spokenByCharacter"?: SchemaValue<Organization | Person | IdReference, "spokenByCharacter">;
}
export interface QuotationLeaf extends QuotationBase {
  "@type": "Quotation";
}
...
export interface RadioSeriesLeaf extends RadioSeriesBase {
  "@type": "RadioSeries";
}
/** CreativeWorkSeries dedicated to radio broadcast and associated online delivery. */
export declare type RadioSeries = RadioSeriesLeaf;
export interface RadioStationLeaf extends LocalBusinessBase {
  "@type": "RadioStation";
}
/** A radio station. */
export declare type RadioStation = RadioStationLeaf | string;
export interface RatingBase extends ThingBase {
  /** The author of this content or rating. Please note that author is special in that HTML 5 provides a special mechanism for indicating authorship via the rel tag. That is equivalent to this and may be used interchangeably. */
  "author"?: SchemaValue<Organization | Person | IdReference, "author">;
...
export interface RatingLeaf extends RatingBase {
  "@type": "Rating";
}
/** A rating is an evaluation on a numeric scale, such as 1 to 5 stars. */
export declare type Rating = RatingLeaf | AggregateRating | EndorsementRating;
export interface ReactActionLeaf extends ActionBase {
  "@type": "ReactAction";
}
...
export interface ReadActionLeaf extends ConsumeActionBase {
  "@type": "ReadAction";
}
/** The act of consuming written content. */
export declare type ReadAction = ReadActionLeaf;
export interface RealEstateAgentLeaf extends LocalBusinessBase {
  "@type": "RealEstateAgent";
}
/** A real-estate agent. */
export declare type RealEstateAgent = RealEstateAgentLeaf | string;
export interface RealEstateListingBase extends WebPageBase {
  /** Publication date of an online listing. */
  "datePosted"?: SchemaValue<Date | DateTime, "datePosted">;
  /** Length of the lease for some {@link https://schema.org/Accommodation Accommodation}, either particular to some {@link https://schema.org/Offer Offer} or in some cases intrinsic to the property. */
  "leaseLength"?: SchemaValue<Duration | QuantitativeValue | IdReference, "leaseLength">;
}
export interface RealEstateListingLeaf extends RealEstateListingBase {
...
export interface ReceiveActionBase extends TransferActionBase {
  /** A sub property of instrument. The method of delivery. */
  "deliveryMethod"?: SchemaValue<DeliveryMethod | IdReference, "deliveryMethod">;
  /** A sub property of participant. The participant who is at the sending end of the action. */
  "sender"?: SchemaValue<Audience | Organization | Person | IdReference, "sender">;
}
export interface ReceiveActionLeaf extends ReceiveActionBase {
  "@type": "ReceiveAction";
}
/**
...
export interface RecipeBase extends HowToBase {
...
export interface RecipeLeaf extends RecipeBase {
  "@type": "Recipe";
}
...
export interface RecommendationBase extends ReviewBase {
  /** A category for the item. Greater signs or slashes can be used to informally indicate a category hierarchy. */
  "category"?: SchemaValue<PhysicalActivityCategory | Text | Thing | URL | IdReference, "category">;
}
export interface RecommendationLeaf extends RecommendationBase {
  "@type": "Recommendation";
}
...
export interface RecommendedDoseScheduleLeaf extends DoseScheduleBase {
...
export interface RecyclingCenterLeaf extends LocalBusinessBase {
  "@type": "RecyclingCenter";
}
/** A recycling center. */
export declare type RecyclingCenter = RecyclingCenterLeaf | string;
export interface RefundTypeEnumerationLeaf extends EnumerationBase {
...
export interface RegisterActionLeaf extends ActionBase {
  "@type": "RegisterAction";
}
/**
...
export interface RejectActionLeaf extends ActionBase {
  "@type": "RejectAction";
}
/**
...
export interface RentActionBase extends TradeActionBase {
...
export interface RentActionLeaf extends RentActionBase {
  "@type": "RentAction";
}
/** The act of giving money in return for temporary use, but not ownership, of an object such as a vehicle or property. For example, an agent rents a property from a landlord in exchange for a periodic payment. */
export declare type RentAction = RentActionLeaf;
export interface RentalCarReservationBase extends ReservationBase {
...
export interface RentalCarReservationLeaf extends RentalCarReservationBase {
...
export interface RepaymentSpecificationBase extends ThingBase {
...
export interface RepaymentSpecificationLeaf extends RepaymentSpecificationBase {
  "@type": "RepaymentSpecification";
}
/** A structured value representing repayment. */
export declare type RepaymentSpecification = RepaymentSpecificationLeaf;
export interface ReplaceActionBase extends UpdateActionBase {
  /** A sub property of object. The object that is being replaced. */
  "replacee"?: SchemaValue<Thing | IdReference, "replacee">;
  /** A sub property of object. The object that replaces. */
  "replacer"?: SchemaValue<Thing | IdReference, "replacer">;
}
export interface ReplaceActionLeaf extends ReplaceActionBase {
  "@type": "ReplaceAction";
}
/** The act of editing a recipient by replacing an old object with a new object. */
export declare type ReplaceAction = ReplaceActionLeaf;
export interface ReplyActionBase extends CommunicateActionBase {
  /** A sub property of result. The Comment created or sent as a result of this action. */
  "resultComment"?: SchemaValue<Comment | IdReference, "resultComment">;
}
export interface ReplyActionLeaf extends ReplyActionBase {
  "@type": "ReplyAction";
}
/**
...
export interface ReportBase extends ArticleBase {
  /** The number or other unique designator assigned to a Report by the publishing organization. */
  "reportNumber"?: SchemaValue<Text, "reportNumber">;
}
export interface ReportLeaf extends ReportBase {
  "@type": "Report";
}
/** A Report generated by governmental or non-governmental organization. */
export declare type Report = ReportLeaf;
export interface ReportageNewsArticleLeaf extends NewsArticleBase {
...
export interface ReservationLeaf extends ReservationBase {
  "@type": "Reservation";
}
/**
...
export interface ReservationPackageBase extends ReservationBase {
  /** The individual reservations included in the package. Typically a repeated property. */
  "subReservation"?: SchemaValue<Reservation | IdReference, "subReservation">;
}
export interface ReservationPackageLeaf extends ReservationPackageBase {
  "@type": "ReservationPackage";
}
/** A group of multiple reservations with common values for all sub-reservations. */
export declare type ReservationPackage = ReservationPackageLeaf;
export interface ReservationStatusTypeLeaf extends EnumerationBase {
...
export interface ReserveActionLeaf extends PlanActionBase {
  "@type": "ReserveAction";
}
/**
...
export interface ReservoirLeaf extends PlaceBase {
  "@type": "Reservoir";
}
/** A reservoir of water, typically an artificially created lake, like the Lake Kariba reservoir. */
export declare type Reservoir = ReservoirLeaf | string;
export interface ResidenceBase extends PlaceBase {
  /** A floorplan of some {@link https://schema.org/Accommodation Accommodation}. */
  "accommodationFloorPlan"?: SchemaValue<FloorPlan | IdReference, "accommodationFloorPlan">;
}
export interface ResidenceLeaf extends ResidenceBase {
  "@type": "Residence";
}
/** The place where a person lives. */
export declare type Residence = ResidenceLeaf | ApartmentComplex | GatedResidenceCommunity | string;
export interface ResortLeaf extends LodgingBusinessBase {
  "@type": "Resort";
}
/**
...
export interface RespiratoryTherapyLeaf extends MedicalTherapyBase {
...
export declare type RespiratoryTherapy = RespiratoryTherapyLeaf;
export interface RestaurantLeaf extends FoodEstablishmentBase {
  "@type": "Restaurant";
}
/** A restaurant. */
export declare type Restaurant = RestaurantLeaf | string;
export interface RestrictedDietLeaf extends EnumerationBase {
  "@type": "RestrictedDiet";
}
...
export interface ResumeActionLeaf extends ActionBase {
  "@type": "ResumeAction";
}
/** The act of resuming a device or application which was formerly paused (e.g. resume music playback or resume a timer). */
export declare type ResumeAction = ResumeActionLeaf;
export interface ReturnActionBase extends TransferActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface ReturnActionLeaf extends ReturnActionBase {
  "@type": "ReturnAction";
}
/** The act of returning to the origin that which was previously received (concrete objects) or taken (ownership). */
export declare type ReturnAction = ReturnActionLeaf;
export interface ReturnFeesEnumerationLeaf extends EnumerationBase {
  "@type": "ReturnFeesEnumeration";
}
/** Enumerates several kinds of policies for product return fees. */
export declare type ReturnFeesEnumeration = "https://schema.org/FreeReturn" | "FreeReturn" | "https://schema.org/OriginalShippingFees" | "OriginalShippingFees" | "https://schema.org/RestockingFees" | "RestockingFees" | "https://schema.org/ReturnFeesCustomerResponsibility" | "ReturnFeesCustomerResponsibility" | "https://schema.org/ReturnShippingFees" | "ReturnShippingFees" | ReturnFeesEnumerationLeaf;
export interface ReturnLabelSourceEnumerationLeaf extends EnumerationBase {
  "@type": "ReturnLabelSourceEnumeration";
}
/** Enumerates several types of return labels for product returns. */
export declare type ReturnLabelSourceEnumeration = "https://schema.org/ReturnLabelCustomerResponsibility" | "ReturnLabelCustomerResponsibility" | "https://schema.org/ReturnLabelDownloadAndPrint" | "ReturnLabelDownloadAndPrint" | "https://schema.org/ReturnLabelInBox" | "ReturnLabelInBox" | ReturnLabelSourceEnumerationLeaf;
export interface ReturnMethodEnumerationLeaf extends EnumerationBase {
  "@type": "ReturnMethodEnumeration";
}
/** Enumerates several types of product return methods. */
export declare type ReturnMethodEnumeration = "https://schema.org/ReturnAtKiosk" | "ReturnAtKiosk" | "https://schema.org/ReturnByMail" | "ReturnByMail" | "https://schema.org/ReturnInStore" | "ReturnInStore" | ReturnMethodEnumerationLeaf;
export interface ReviewBase extends CreativeWorkBase {
...
export interface ReviewLeaf extends ReviewBase {
  "@type": "Review";
}
...
export interface ReviewActionBase extends ActionBase {
  /** A sub property of result. The review that resulted in the performing of the action. */
  "resultReview"?: SchemaValue<Review | IdReference, "resultReview">;
}
export interface ReviewActionLeaf extends ReviewActionBase {
  "@type": "ReviewAction";
}
/** The act of producing a balanced opinion about the object for an audience. An agent reviews an object with participants resulting in a review. */
export declare type ReviewAction = ReviewActionLeaf;
export interface ReviewNewsArticleBase extends ReviewBase, NewsArticleBase {
}
export interface ReviewNewsArticleLeaf extends ReviewNewsArticleBase {
...
export interface RiverBodyOfWaterLeaf extends PlaceBase {
  "@type": "RiverBodyOfWater";
}
/** A river (for example, the broad majestic Shannon). */
export declare type RiverBodyOfWater = RiverBodyOfWaterLeaf | string;
export interface RoofingContractorLeaf extends LocalBusinessBase {
  "@type": "RoofingContractor";
}
/** A roofing contractor. */
export declare type RoofingContractor = RoofingContractorLeaf | string;
export interface RoomLeaf extends AccommodationBase {
  "@type": "Room";
}
/**
...
export interface RsvpActionBase extends InformActionBase {
...
export interface RsvpActionLeaf extends RsvpActionBase {
  "@type": "RsvpAction";
}
/** The act of notifying an event organizer as to whether you expect to attend the event. */
export declare type RsvpAction = RsvpActionLeaf;
export interface RsvpResponseTypeLeaf extends EnumerationBase {
...
export interface RVParkLeaf extends CivicStructureBase {
  "@type": "RVPark";
}
/** A place offering space for "Recreational Vehicles", Caravans, mobile homes and the like. */
export declare type RVPark = RVParkLeaf | string;
export interface SaleEventLeaf extends EventBase {
  "@type": "SaleEvent";
}
/** Event type: Sales event. */
export declare type SaleEvent = SaleEventLeaf;
export interface SatiricalArticleLeaf extends ArticleBase {
...
export interface ScheduleBase extends ThingBase {
...
export interface ScheduleLeaf extends ScheduleBase {
  "@type": "Schedule";
}
...
export interface ScheduleActionLeaf extends PlanActionBase {
  "@type": "ScheduleAction";
}
/**
...
export interface ScholarlyArticleLeaf extends ArticleBase {
  "@type": "ScholarlyArticle";
}
/** A scholarly article. */
export declare type ScholarlyArticle = ScholarlyArticleLeaf | MedicalScholarlyArticle;
export interface SchoolLeaf extends EducationalOrganizationBase {
  "@type": "School";
}
/** A school. */
export declare type School = SchoolLeaf | string;
export interface SchoolDistrictLeaf extends PlaceBase {
  "@type": "SchoolDistrict";
}
/** A School District is an administrative area for the administration of schools. */
export declare type SchoolDistrict = SchoolDistrictLeaf | string;
export interface ScreeningEventBase extends EventBase {
  /** Languages in which subtitles/captions are available, in {@link http://tools.ietf.org/html/bcp47 IETF BCP 47 standard format}. */
  "subtitleLanguage"?: SchemaValue<Language | Text | IdReference, "subtitleLanguage">;
  /** The type of screening or video broadcast used (e.g. IMAX, 3D, SD, HD, etc.). */
  "videoFormat"?: SchemaValue<Text, "videoFormat">;
...
export interface ScreeningEventLeaf extends ScreeningEventBase {
  "@type": "ScreeningEvent";
}
/** A screening of a movie or other video. */
export declare type ScreeningEvent = ScreeningEventLeaf;
export interface SculptureLeaf extends CreativeWorkBase {
  "@type": "Sculpture";
}
/** A piece of sculpture. */
export declare type Sculpture = SculptureLeaf;
export interface SeaBodyOfWaterLeaf extends PlaceBase {
  "@type": "SeaBodyOfWater";
}
/** A sea (for example, the Caspian sea). */
export declare type SeaBodyOfWater = SeaBodyOfWaterLeaf | string;
export interface SearchActionBase extends ActionBase {
  /** A sub property of instrument. The query used on this action. */
  "query"?: SchemaValue<Text, "query">;
}
export interface SearchActionLeaf extends SearchActionBase {
  "@type": "SearchAction";
}
/**
...
export interface SearchResultsPageLeaf extends WebPageBase {
  "@type": "SearchResultsPage";
}
/** Web page type: Search results page. */
export declare type SearchResultsPage = SearchResultsPageLeaf;
export interface SeasonLeaf extends CreativeWorkBase {
  "@type": "Season";
}
/**
* A media season e.g. tv, radio, video game etc.
...
export interface SeatBase extends ThingBase {
...
export interface SeatLeaf extends SeatBase {
  "@type": "Seat";
}
/** Used to describe a seat, such as a reserved seat in an event reservation. */
export declare type Seat = SeatLeaf;
export interface SeekToActionBase extends ActionBase {
  /** The start time of the clip expressed as the number of seconds from the beginning of the work. */
  "startOffset"?: SchemaValue<HyperTocEntry | Number | IdReference, "startOffset">;
}
export interface SeekToActionLeaf extends SeekToActionBase {
  "@type": "SeekToAction";
}
...
export interface SelfStorageLeaf extends LocalBusinessBase {
  "@type": "SelfStorage";
}
/** A self-storage facility. */
export declare type SelfStorage = SelfStorageLeaf | string;
export interface SellActionBase extends TradeActionBase {
...
export interface SellActionLeaf extends SellActionBase {
  "@type": "SellAction";
}
/** The act of taking money from a buyer in exchange for goods or services rendered. An agent sells an object, product, or service to a buyer for a price. Reciprocal of BuyAction. */
export declare type SellAction = SellActionLeaf;
export interface SendActionBase extends TransferActionBase {
  /** A sub property of instrument. The method of delivery. */
  "deliveryMethod"?: SchemaValue<DeliveryMethod | IdReference, "deliveryMethod">;
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface SendActionLeaf extends SendActionBase {
  "@type": "SendAction";
}
/**
...
export interface SeriesLeaf extends ThingBase {
  "@type": "Series";
}
...
export interface ServiceBase extends ThingBase {
  /** The overall rating, based on a collection of reviews or ratings, of the item. */
  "aggregateRating"?: SchemaValue<AggregateRating | IdReference, "aggregateRating">;
  /** The geographic area where a service or offered item is provided. */
  "areaServed"?: SchemaValue<AdministrativeArea | GeoShape | Place | Text | IdReference, "areaServed">;
...
export interface ServiceLeaf extends ServiceBase {
  "@type": "Service";
}
...
export interface ServiceChannelBase extends ThingBase {
  /** A language someone may use with or at the item, service or place. Please use one of the language codes from the {@link http://tools.ietf.org/html/bcp47 IETF BCP 47 standard}. See also {@link https://schema.org/inLanguage inLanguage} */
  "availableLanguage"?: SchemaValue<Language | Text | IdReference, "availableLanguage">;
...
export interface ServiceChannelLeaf extends ServiceChannelBase {
  "@type": "ServiceChannel";
}
/** A means for accessing a service, e.g. a government office location, web site, or phone number. */
export declare type ServiceChannel = ServiceChannelLeaf;
export interface ShareActionLeaf extends CommunicateActionBase {
  "@type": "ShareAction";
}
/** The act of distributing content to people for their amusement or edification. */
export declare type ShareAction = ShareActionLeaf;
export interface SheetMusicLeaf extends CreativeWorkBase {
  "@type": "SheetMusic";
}
/** Printed music, as opposed to performed or recorded music. */
export declare type SheetMusic = SheetMusicLeaf;
export interface ShippingDeliveryTimeBase extends ThingBase {
...
export interface ShippingDeliveryTimeLeaf extends ShippingDeliveryTimeBase {
  "@type": "ShippingDeliveryTime";
}
/** ShippingDeliveryTime provides various pieces of information about delivery times for shipping. */
export declare type ShippingDeliveryTime = ShippingDeliveryTimeLeaf;
export interface ShippingRateSettingsBase extends ThingBase {
  /** Indicates when shipping to a particular {@link https://schema.org/shippingDestination shippingDestination} is not available. */
  "doesNotShip"?: SchemaValue<Boolean, "doesNotShip">;
...
export interface ShippingRateSettingsLeaf extends ShippingRateSettingsBase {
...
export interface ShoeStoreLeaf extends LocalBusinessBase {
  "@type": "ShoeStore";
}
/** A shoe store. */
export declare type ShoeStore = ShoeStoreLeaf | string;
export interface ShoppingCenterLeaf extends LocalBusinessBase {
  "@type": "ShoppingCenter";
}
/** A shopping center or mall. */
export declare type ShoppingCenter = ShoppingCenterLeaf | string;
export interface ShortStoryLeaf extends CreativeWorkBase {
  "@type": "ShortStory";
}
/** Short story or tale. A brief work of literature, usually written in narrative prose. */
export declare type ShortStory = ShortStoryLeaf;
export interface SingleFamilyResidenceBase extends HouseBase {
  /** The number of rooms (excluding bathrooms and closets) of the accommodation or lodging business. Typical unit code(s): ROM for room or C62 for no unit. The type of room can be put in the unitText property of the QuantitativeValue. */
  "numberOfRooms"?: SchemaValue<Number | QuantitativeValue | IdReference, "numberOfRooms">;
  /** The allowed total occupancy for the accommodation in persons (including infants etc). For individual accommodations, this is not necessarily the legal maximum but defines the permitted usage as per the contractual agreement (e.g. a double room used by a single person). Typical unit code(s): C62 for person */
  "occupancy"?: SchemaValue<QuantitativeValue | IdReference, "occupancy">;
}
export interface SingleFamilyResidenceLeaf extends SingleFamilyResidenceBase {
...
export interface SizeGroupEnumerationLeaf extends EnumerationBase {
...
export interface SizeSpecificationBase extends QualitativeValueBase {
  /** A product measurement, for example the inseam of pants, the wheel size of a bicycle, or the gauge of a screw. Usually an exact measurement, but can also be a range of measurements for adjustable products, for example belts and ski bindings. */
  "hasMeasurement"?: SchemaValue<QuantitativeValue | IdReference, "hasMeasurement">;
...
export interface SizeSpecificationLeaf extends SizeSpecificationBase {
...
export interface SizeSystemEnumerationLeaf extends EnumerationBase {
  "@type": "SizeSystemEnumeration";
}
/** Enumerates common size systems for different categories of products, for example "EN-13402" or "UK" for wearables or "Imperial" for screws. */
export declare type SizeSystemEnumeration = "https://schema.org/SizeSystemImperial" | "SizeSystemImperial" | "https://schema.org/SizeSystemMetric" | "SizeSystemMetric" | SizeSystemEnumerationLeaf | WearableSizeSystemEnumeration;
export interface SkiResortBase extends LodgingBusinessBase, LocalBusinessBase {
}
export interface SkiResortLeaf extends SkiResortBase {
  "@type": "SkiResort";
}
/** A ski resort. */
export declare type SkiResort = SkiResortLeaf | string;
export interface SocialEventLeaf extends EventBase {
  "@type": "SocialEvent";
}
/** Event type: Social event. */
export declare type SocialEvent = SocialEventLeaf;
export interface SocialMediaPostingBase extends ArticleBase {
  /** A CreativeWork such as an image, video, or audio clip shared as part of this posting. */
  "sharedContent"?: SchemaValue<CreativeWork | IdReference, "sharedContent">;
}
export interface SocialMediaPostingLeaf extends SocialMediaPostingBase {
  "@type": "SocialMediaPosting";
}
/** A post to a social media platform, including blog posts, tweets, Facebook posts, etc. */
export declare type SocialMediaPosting = SocialMediaPostingLeaf | BlogPosting | DiscussionForumPosting;
export interface SoftwareApplicationBase extends CreativeWorkBase {
...
export interface SoftwareApplicationLeaf extends SoftwareApplicationBase {
  "@type": "SoftwareApplication";
}
/** A software application. */
export declare type SoftwareApplication = SoftwareApplicationLeaf | MobileApplication | VideoGame | WebApplication;
export interface SoftwareSourceCodeBase extends CreativeWorkBase {
...
export interface SoftwareSourceCodeLeaf extends SoftwareSourceCodeBase {
  "@type": "SoftwareSourceCode";
}
/** Computer programming source code. Example: Full (compile ready) solutions, code snippet samples, scripts, templates. */
export declare type SoftwareSourceCode = SoftwareSourceCodeLeaf;
export interface SolveMathActionBase extends ActionBase {
  /** For questions that are part of learning resources (e.g. Quiz), eduQuestionType indicates the format of question being given. Example: "Multiple choice", "Open ended", "Flashcard". */
  "eduQuestionType"?: SchemaValue<Text, "eduQuestionType">;
}
export interface SolveMathActionLeaf extends SolveMathActionBase {
  "@type": "SolveMathAction";
}
/** The action that takes in a math expression and directs users to a page potentially capable of solving/simplifying that expression. */
export declare type SolveMathAction = SolveMathActionLeaf;
export interface SomeProductsBase extends ProductBase {
  /** The current approximate inventory level for the item or items. */
  "inventoryLevel"?: SchemaValue<QuantitativeValue | IdReference, "inventoryLevel">;
}
export interface SomeProductsLeaf extends SomeProductsBase {
  "@type": "SomeProducts";
}
/** A placeholder for multiple similar products of the same kind. */
export declare type SomeProducts = SomeProductsLeaf;
export interface SpeakableSpecificationBase extends ThingBase {
...
export interface SpeakableSpecificationLeaf extends SpeakableSpecificationBase {
...
export interface SpecialAnnouncementBase extends CreativeWorkBase {
...
export interface SpecialAnnouncementLeaf extends SpecialAnnouncementBase {
...
export interface SpecialtyLeaf extends EnumerationBase {
  "@type": "Specialty";
}
/** Any branch of a field in which people typically develop specific expertise, usually after significant study, time, and effort. */
export declare type Specialty = SpecialtyLeaf | MedicalSpecialty;
export interface SportingGoodsStoreLeaf extends LocalBusinessBase {
  "@type": "SportingGoodsStore";
}
/** A sporting goods store. */
export declare type SportingGoodsStore = SportingGoodsStoreLeaf | string;
export interface SportsActivityLocationLeaf extends LocalBusinessBase {
...
export interface SportsClubLeaf extends LocalBusinessBase {
  "@type": "SportsClub";
}
/** A sports club. */
export declare type SportsClub = SportsClubLeaf | string;
export interface SportsEventBase extends EventBase {
...
export interface SportsEventLeaf extends SportsEventBase {
  "@type": "SportsEvent";
}
/** Event type: Sports event. */
export declare type SportsEvent = SportsEventLeaf;
export interface SportsOrganizationBase extends OrganizationBase {
  /** A type of sport (e.g. Baseball). */
  "sport"?: SchemaValue<Text | URL, "sport">;
}
export interface SportsOrganizationLeaf extends SportsOrganizationBase {
  "@type": "SportsOrganization";
}
/** Represents the collection of all sports organizations, including sports teams, governing bodies, and sports associations. */
export declare type SportsOrganization = SportsOrganizationLeaf | SportsTeam | string;
export interface SportsTeamBase extends SportsOrganizationBase {
...
export interface SportsTeamLeaf extends SportsTeamBase {
  "@type": "SportsTeam";
}
/** Organization: Sports team. */
export declare type SportsTeam = SportsTeamLeaf | string;
export interface SpreadsheetDigitalDocumentLeaf extends DigitalDocumentBase {
  "@type": "SpreadsheetDigitalDocument";
}
/** A spreadsheet file. */
export declare type SpreadsheetDigitalDocument = SpreadsheetDigitalDocumentLeaf;
export interface StadiumOrArenaBase extends LocalBusinessBase, CivicStructureBase {
}
export interface StadiumOrArenaLeaf extends StadiumOrArenaBase {
  "@type": "StadiumOrArena";
}
/** A stadium. */
export declare type StadiumOrArena = StadiumOrArenaLeaf | string;
export interface StateLeaf extends PlaceBase {
  "@type": "State";
}
/** A state or province of a country. */
export declare type State = StateLeaf | string;
export interface StatementLeaf extends CreativeWorkBase {
  "@type": "Statement";
}
...
export interface StatisticalPopulationBase extends ThingBase {
  ...
  "constrainingProperty"?: SchemaValue<Integer, "constrainingProperty">;
...
export interface StatisticalPopulationLeaf extends StatisticalPopulationBase {
...
export interface StatusEnumerationLeaf extends EnumerationBase {
...
export interface SteeringPositionValueLeaf extends QualitativeValueBase {
...
export interface StoreLeaf extends LocalBusinessBase {
  "@type": "Store";
}
/** A retail good store. */
...
export interface StructuredValueLeaf extends ThingBase {
...
export interface SubscribeActionLeaf extends ActionBase {
...
export interface SubstanceBase extends MedicalEntityBase {
  /** An active ingredient, typically chemical compounds and/or biologic substances. */
  "activeIngredient"?: SchemaValue<Text, "activeIngredient">;
  /** Recommended intake of this supplement for a given population as defined by a specific recommending authority. */
  "maximumIntake"?: SchemaValue<MaximumDoseSchedule | IdReference, "maximumIntake">;
}
export interface SubstanceLeaf extends SubstanceBase {
  "@type": "Substance";
}
/** Any matter of defined composition that has discrete existence, whose origin may be biological, mineral or chemical. */
export declare type Substance = SubstanceLeaf | DietarySupplement | Drug;
export interface SubwayStationLeaf extends CivicStructureBase {
  "@type": "SubwayStation";
}
/** A subway station. */
export declare type SubwayStation = SubwayStationLeaf | string;
export interface SuiteBase extends AccommodationBase {
  /** The type of bed or beds included in the accommodation. For the single case of just one bed of a certain type, you use bed directly with a text. If you want to indicate the quantity of a certain kind of bed, use an instance of BedDetails. For more detailed information, use the amenityFeature property. */
  "bed"?: SchemaValue<BedDetails | BedType | Text | IdReference, "bed">;
  /** The number of rooms (excluding bathrooms and closets) of the accommodation or lodging business. Typical unit code(s): ROM for room or C62 for no unit. The type of room can be put in the unitText property of the QuantitativeValue. */
  "numberOfRooms"?: SchemaValue<Number | QuantitativeValue | IdReference, "numberOfRooms">;
...
export interface SuiteLeaf extends SuiteBase {
  "@type": "Suite";
}
/**
...
export interface SuperficialAnatomyBase extends MedicalEntityBase {
  /** If applicable, a description of the pathophysiology associated with the anatomical system, including potential abnormal changes in the mechanical, physical, and biochemical functions of the system. */
  "associatedPathophysiology"?: SchemaValue<Text, "associatedPathophysiology">;
...
export interface SuperficialAnatomyLeaf extends SuperficialAnatomyBase {
...
export interface SurgicalProcedureLeaf extends MedicalProcedureBase {
  "@type": "SurgicalProcedure";
}
/** A medical procedure involving an incision with instruments; performed for diagnose, or therapeutic purposes. */
export declare type SurgicalProcedure = SurgicalProcedureLeaf;
export interface SuspendActionLeaf extends ActionBase {
  "@type": "SuspendAction";
}
/** The act of momentarily pausing a device or application (e.g. pause music playback or pause a timer). */
export declare type SuspendAction = SuspendActionLeaf;
export interface SynagogueLeaf extends CivicStructureBase {
  "@type": "Synagogue";
}
/** A synagogue. */
export declare type Synagogue = SynagogueLeaf | string;
export interface TableLeaf extends WebPageElementBase {
  "@type": "Table";
}
/** A table on a Web page. */
export declare type Table = TableLeaf;
export interface TakeActionLeaf extends TransferActionBase {
  "@type": "TakeAction";
}
/**
...
export interface TattooParlorLeaf extends LocalBusinessBase {
  "@type": "TattooParlor";
}
/** A tattoo parlor. */
export declare type TattooParlor = TattooParlorLeaf | string;
export interface TaxiLeaf extends ServiceBase {
  "@type": "Taxi";
}
/**
* A taxi.
...
export interface TaxiReservationBase extends ReservationBase {
  /** Number of people the reservation should accommodate. */
  "partySize"?: SchemaValue<Integer | QuantitativeValue | IdReference, "partySize">;
  /** Where a taxi will pick up a passenger or a rental car can be picked up. */
  "pickupLocation"?: SchemaValue<Place | IdReference, "pickupLocation">;
...
export interface TaxiReservationLeaf extends TaxiReservationBase {
...
export interface TaxiServiceLeaf extends ServiceBase {
  "@type": "TaxiService";
}
/** A service for a vehicle for hire with a driver for local travel. Fares are usually calculated based on distance traveled. */
export declare type TaxiService = TaxiServiceLeaf;
export interface TaxiStandLeaf extends CivicStructureBase {
  "@type": "TaxiStand";
}
/** A taxi stand. */
export declare type TaxiStand = TaxiStandLeaf | string;
export interface TaxonBase extends ThingBase {
...
export interface TherapeuticProcedureLeaf extends TherapeuticProcedureBase {
...
export interface ThesisBase extends CreativeWorkBase {
  /** Qualification, candidature, degree, application that Thesis supports. */
  "inSupportOf"?: SchemaValue<Text, "inSupportOf">;
}
export interface ThesisLeaf extends ThesisBase {
  "@type": "Thesis";
}
...
export interface ThingBase extends Partial<IdReference> {
  ...
  "additionalType"?: SchemaValue<URL, "additionalType">;
...
export declare type Thing = ThingLeaf | Action | BioChemEntity | CreativeWork | Event | Intangible | MedicalEntity | Organization | Person | Place | Product | Taxon;
export interface TicketBase extends ThingBase {
...
export interface TicketLeaf extends TicketBase {
  "@type": "Ticket";
}
/** Used to describe a ticket to an event, a flight, a bus ride, etc. */
export declare type Ticket = TicketLeaf;
export interface TieActionLeaf extends ActionBase {
  "@type": "TieAction";
}
/** The act of reaching a draw in a competitive activity. */
export declare type TieAction = TieActionLeaf;
export interface TipActionBase extends TradeActionBase {
  /** A sub property of participant. The participant who is at the receiving end of the action. */
  "recipient"?: SchemaValue<Audience | ContactPoint | Organization | Person | IdReference, "recipient">;
}
export interface TipActionLeaf extends TipActionBase {
  "@type": "TipAction";
}
/** The act of giving money voluntarily to a beneficiary in recognition of services rendered. */
export declare type TipAction = TipActionLeaf;
export interface TireShopLeaf extends LocalBusinessBase {
  "@type": "TireShop";
}
/** A tire shop. */
export declare type TireShop = TireShopLeaf | string;
export interface TouristAttractionBase extends PlaceBase {
  /** A language someone may use with or at the item, service or place. Please use one of the language codes from the {@link http://tools.ietf.org/html/bcp47 IETF BCP 47 standard}. See also {@link https://schema.org/inLanguage inLanguage} */
  "availableLanguage"?: SchemaValue<Language | Text | IdReference, "availableLanguage">;
  /** Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc. */
  "touristType"?: SchemaValue<Audience | Text | IdReference, "touristType">;
}
export interface TouristAttractionLeaf extends TouristAttractionBase {
...
export interface TouristDestinationBase extends PlaceBase {
  /** Attraction located at destination. */
  "includesAttraction"?: SchemaValue<TouristAttraction | IdReference, "includesAttraction">;
  /** Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc. */
  "touristType"?: SchemaValue<Audience | Text | IdReference, "touristType">;
}
export interface TouristDestinationLeaf extends TouristDestinationBase {
...
export interface TouristInformationCenterLeaf extends LocalBusinessBase {
  "@type": "TouristInformationCenter";
}
/** A tourist information center. */
export declare type TouristInformationCenter = TouristInformationCenterLeaf | string;
export interface TouristTripBase extends TripBase {
  /** Attraction suitable for type(s) of tourist. eg. Children, visitors from a particular country, etc. */
  "touristType"?: SchemaValue<Audience | Text | IdReference, "touristType">;
}
export interface TouristTripLeaf extends TouristTripBase {
  "@type": "TouristTrip";
}
...
export interface ToyStoreLeaf extends LocalBusinessBase {
  "@type": "ToyStore";
}
/** A toy store. */
export declare type ToyStore = ToyStoreLeaf | string;
export interface TrackActionBase extends ActionBase {
  /** A sub property of instrument. The method of delivery. */
  "deliveryMethod"?: SchemaValue<DeliveryMethod | IdReference, "deliveryMethod">;
}
export interface TrackActionLeaf extends TrackActionBase {
  "@type": "TrackAction";
}
/**
...
export interface TradeActionBase extends ActionBase {
  /**
   * The offer price of a product, or of a price component when attached to PriceSpecification and its subtypes.
   *
   * Usage guidelines:
...
export interface TradeActionLeaf extends TradeActionBase {
  "@type": "TradeAction";
}
...
export interface TrainReservationLeaf extends ReservationBase {
...
export interface TrainStationLeaf extends CivicStructureBase {
  "@type": "TrainStation";
}
/** A train station. */
export declare type TrainStation = TrainStationLeaf | string;
export interface TrainTripBase extends TripBase {
...
export interface TrainTripLeaf extends TrainTripBase {
  "@type": "TrainTrip";
}
/** A trip on a commercial train line. */
export declare type TrainTrip = TrainTripLeaf;
export interface TransferActionBase extends ActionBase {
  /** A sub property of location. The original location of the object or the agent before the action. */
  "fromLocation"?: SchemaValue<Place | IdReference, "fromLocation">;
  /** A sub property of location. The final location of the object or the agent after the action. */
  "toLocation"?: SchemaValue<Place | IdReference, "toLocation">;
}
export interface TransferActionLeaf extends TransferActionBase {
  "@type": "TransferAction";
}
...
export interface TravelActionBase extends MoveActionBase {
  /** The distance travelled, e.g. exercising or travelling. */
  "distance"?: SchemaValue<Distance | IdReference, "distance">;
}
export interface TravelActionLeaf extends TravelActionBase {
  "@type": "TravelAction";
}
/** The act of traveling from an fromLocation to a destination by a specified mode of transport, optionally with participants. */
export declare type TravelAction = TravelActionLeaf;
export interface TravelAgencyLeaf extends LocalBusinessBase {
  "@type": "TravelAgency";
}
/** A travel agency. */
export declare type TravelAgency = TravelAgencyLeaf | string;
export interface TreatmentIndicationLeaf extends MedicalEntityBase {
  "@type": "TreatmentIndication";
}
/** An indication for treating an underlying condition, symptom, etc. */
export declare type TreatmentIndication = TreatmentIndicationLeaf;
export interface TripBase extends ThingBase {
...
export interface TVClipLeaf extends TVClipBase {
  "@type": "TVClip";
}
/** A short TV program or a segment/part of a TV program. */
export declare type TVClip = TVClipLeaf;
export interface TVEpisodeBase extends EpisodeBase {
  /**
   * The country of origin of something, including products as well as creative works such as movie and TV content.
   *
   * In the case of TV and movie, this would be the country of the principle offices of the production company or individual responsible for the movie. For other kinds of {@link https://schema.org/CreativeWork CreativeWork} it is difficult to provide fully general guidance, and properties such as {@link https://schema.org/contentLocation contentLocation} and {@link https://schema.org/locationCreated locationCreated} may be more applicable.
...
export interface TVEpisodeLeaf extends TVEpisodeBase {
  "@type": "TVEpisode";
}
/** A TV episode which can be part of a series or season. */
export declare type TVEpisode = TVEpisodeLeaf;
export interface TVSeasonBase extends CreativeWorkSeasonBase, CreativeWorkBase {
  /**
   * The country of origin of something, including products as well as creative works such as movie and TV content.
   *
   * In the case of TV and movie, this would be the country of the principle offices of the production company or individual responsible for the movie. For other kinds of {@link https://schema.org/CreativeWork CreativeWork} it is difficult to provide fully general guidance, and properties such as {@link https://schema.org/contentLocation contentLocation} and {@link https://schema.org/locationCreated locationCreated} may be more applicable.
...
export interface TVSeasonLeaf extends TVSeasonBase {
  "@type": "TVSeason";
}
/** Season dedicated to TV broadcast and associated online delivery. */
export declare type TVSeason = TVSeasonLeaf;
export interface TVSeriesBase extends CreativeWorkSeriesBase, CreativeWorkBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface TVSeriesLeaf extends TVSeriesBase {
  "@type": "TVSeries";
}
/** CreativeWorkSeries dedicated to TV broadcast and associated online delivery. */
export declare type TVSeries = TVSeriesLeaf;
export interface TypeAndQuantityNodeBase extends ThingBase {
...
export interface TypeAndQuantityNodeLeaf extends TypeAndQuantityNodeBase {
  "@type": "TypeAndQuantityNode";
}
/** A structured value indicating the quantity, unit of measurement, and business function of goods included in a bundle offer. */
export declare type TypeAndQuantityNode = TypeAndQuantityNodeLeaf;
export interface UKNonprofitTypeLeaf extends EnumerationBase {
...
export interface UnitPriceSpecificationBase extends PriceSpecificationBase {
...
export interface UnitPriceSpecificationLeaf extends UnitPriceSpecificationBase {
  "@type": "UnitPriceSpecification";
}
/** The price asked for a given offer by the respective organization or person. */
export declare type UnitPriceSpecification = UnitPriceSpecificationLeaf;
export interface UnRegisterActionLeaf extends ActionBase {
...
export interface UpdateActionBase extends ActionBase {
  /**
...
export interface UpdateActionLeaf extends UpdateActionBase {
  "@type": "UpdateAction";
}
...
export interface UseActionLeaf extends ConsumeActionBase {
  "@type": "UseAction";
}
/** The act of applying an object to its intended purpose. */
export declare type UseAction = UseActionLeaf | WearAction;
export interface UserBlocksLeaf extends EventBase {
  "@type": "UserBlocks";
}
/**
...
export interface UserCheckinsLeaf extends EventBase {
  "@type": "UserCheckins";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserCommentsBase extends EventBase {
...
export interface UserCommentsLeaf extends UserCommentsBase {
  "@type": "UserComments";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserDownloadsLeaf extends EventBase {
  "@type": "UserDownloads";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserInteractionLeaf extends EventBase {
...
export interface UserLikesLeaf extends EventBase {
  "@type": "UserLikes";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserPageVisitsLeaf extends EventBase {
  "@type": "UserPageVisits";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserPlaysLeaf extends EventBase {
  "@type": "UserPlays";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserPlusOnesLeaf extends EventBase {
  "@type": "UserPlusOnes";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface UserReviewLeaf extends ReviewBase {
  "@type": "UserReview";
}
...
export interface UserTweetsLeaf extends EventBase {
  "@type": "UserTweets";
}
/**
* UserInteraction and its subtypes is an old way of talking about users interacting with pages. It is generally better to use {@link https://schema.org/Action Action}-based vocabulary, alongside types such as {@link https://schema.org/Comment Comment}.
...
export interface USNonprofitTypeLeaf extends EnumerationBase {
...
export interface VehicleBase extends ProductBase {
  /**
...
export interface VeinBase extends AnatomicalStructureBase {
...
export interface VeinLeaf extends VeinBase {
  "@type": "Vein";
}
/** A type of blood vessel that specifically carries blood to the heart. */
export declare type Vein = VeinLeaf;
export interface VesselLeaf extends AnatomicalStructureBase {
  "@type": "Vessel";
}
/** A component of the human body circulatory system comprised of an intricate network of hollow tubes that transport blood throughout the entire body. */
export declare type Vessel = VesselLeaf | Artery | LymphaticVessel | Vein;
export interface VeterinaryCareLeaf extends MedicalOrganizationBase {
  "@type": "VeterinaryCare";
}
/** A vet's office. */
export declare type VeterinaryCare = VeterinaryCareLeaf | string;
export interface VideoGalleryLeaf extends WebPageBase {
  "@type": "VideoGallery";
}
/** Web page type: Video gallery page. */
export declare type VideoGallery = VideoGalleryLeaf;
export interface VideoGameBase extends SoftwareApplicationBase, GameBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface VideoGameLeaf extends VideoGameBase {
  "@type": "VideoGame";
}
/** A video game is an electronic game that involves human interaction with a user export interface to generate visual feedback on a video device. */
export declare type VideoGame = VideoGameLeaf;
export interface VideoGameClipLeaf extends ClipBase {
  "@type": "VideoGameClip";
}
/** A short segment/part of a video game. */
export declare type VideoGameClip = VideoGameClipLeaf;
export interface VideoGameSeriesBase extends CreativeWorkSeriesBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface VideoGameSeriesLeaf extends VideoGameSeriesBase {
  "@type": "VideoGameSeries";
}
/** A video game series. */
export declare type VideoGameSeries = VideoGameSeriesLeaf;
export interface VideoObjectBase extends MediaObjectBase {
  /** An actor, e.g. in tv, radio, movie, video games etc., or in an event. Actors can be associated with individual items or with a series, episode, clip. */
  "actor"?: SchemaValue<Person | IdReference, "actor">;
  /**
   * An actor, e.g. in tv, radio, movie, video games etc. Actors can be associated with individual items or with a series, episode, clip.
...
export interface VideoObjectLeaf extends VideoObjectBase {
  "@type": "VideoObject";
}
/** A video file. */
export declare type VideoObject = VideoObjectLeaf | VideoObjectSnapshot;
export interface VideoObjectSnapshotLeaf extends VideoObjectBase {
...
export interface VisualArtworkLeaf extends VisualArtworkBase {
  "@type": "VisualArtwork";
}
/** A work of art that is primarily visual in character. */
export declare type VisualArtwork = VisualArtworkLeaf | CoverArt;
export interface VitalSignLeaf extends MedicalSignBase {
  "@type": "VitalSign";
}
/** Vital signs are measures of various physiological functions in order to assess the most basic body functions. */
export declare type VitalSign = VitalSignLeaf;
export interface VolcanoLeaf extends PlaceBase {
  "@type": "Volcano";
}
/** A volcano, like Fuji san. */
export declare type Volcano = VolcanoLeaf | string;
export interface VoteActionBase extends ChooseActionBase {
  /** A sub property of object. The candidate subject of this action. */
  "candidate"?: SchemaValue<Person | IdReference, "candidate">;
}
export interface VoteActionLeaf extends VoteActionBase {
  "@type": "VoteAction";
}
/** The act of expressing a preference from a fixed/finite/structured set of choices/options. */
export declare type VoteAction = VoteActionLeaf;
export interface WantActionLeaf extends ActionBase {
  "@type": "WantAction";
}
/** The act of expressing a desire about the object. An agent wants an object. */
export declare type WantAction = WantActionLeaf;
export interface WarrantyPromiseBase extends ThingBase {
...
export interface WarrantyPromiseLeaf extends WarrantyPromiseBase {
  "@type": "WarrantyPromise";
}
/** A structured value representing the duration and scope of services that will be provided to a customer free of charge in case of a defect or malfunction of a product. */
export declare type WarrantyPromise = WarrantyPromiseLeaf;
export interface WarrantyScopeLeaf extends EnumerationBase {
  "@type": "WarrantyScope";
}
/**
...
export interface WebPageBase extends CreativeWorkBase {
...
export interface WebPageLeaf extends WebPageBase {
  "@type": "WebPage";
}
...
export interface WebPageElementBase extends CreativeWorkBase {
  /** A CSS selector, e.g. of a {@link https://schema.org/SpeakableSpecification SpeakableSpecification} or {@link https://schema.org/WebPageElement WebPageElement}. In the latter case, multiple matches within a page can constitute a single conceptual "Web page element". */
  "cssSelector"?: SchemaValue<CssSelectorType, "cssSelector">;
  /** An XPath, e.g. of a {@link https://schema.org/SpeakableSpecification SpeakableSpecification} or {@link https://schema.org/WebPageElement WebPageElement}. In the latter case, multiple matches within a page can constitute a single conceptual "Web page element". */
  "xpath"?: SchemaValue<XPathType, "xpath">;
}
export interface WebPageElementLeaf extends WebPageElementBase {
  "@type": "WebPageElement";
}
...
export interface WebSiteBase extends CreativeWorkBase {
  /** The International Standard Serial Number (ISSN) that identifies this serial publication. You can repeat this property to identify different formats of, or the linking ISSN (ISSN-L) for, this serial publication. */
  "issn"?: SchemaValue<Text, "issn">;
}
...
export interface WholesaleStoreLeaf extends LocalBusinessBase {
  "@type": "WholesaleStore";
}
/** A wholesale store. */
export declare type WholesaleStore = WholesaleStoreLeaf | string;
export interface WinActionBase extends ActionBase {
  /** A sub property of participant. The loser of the action. */
  "loser"?: SchemaValue<Person | IdReference, "loser">;
}
export interface WinActionLeaf extends WinActionBase {
  "@type": "WinAction";
}
/** The act of achieving victory in a competitive activity. */
export declare type WinAction = WinActionLeaf;
export interface WineryLeaf extends FoodEstablishmentBase {
  "@type": "Winery";
}
/** A winery. */
export declare type Winery = WineryLeaf | string;
export interface WorkBasedProgramBase extends EducationalOccupationalProgramBase {
  /**
   * A category describing the job, preferably using a term from a taxonomy such as {@link http://www.onetcenter.org/taxonomy.html BLS O*NET-SOC}, {@link https://www.ilo.org/public/english/bureau/stat/isco/isco08/ ISCO-08} or similar, with the property repeated for each applicable value. Ideally the taxonomy should be identified, and both the textual label and formal code for the category should be provided.
   *
   * Note: for historical reasons, any textual label and formal code provided as a literal may be assumed to be from O*NET-SOC.
...
export interface WorkBasedProgramLeaf extends WorkBasedProgramBase {
...
export interface WorkersUnionLeaf extends OrganizationBase {
  "@type": "WorkersUnion";
}
/** A Workers Union (also known as a Labor Union, Labour Union, or Trade Union) is an organization that promotes the interests of its worker members by collectively bargaining with management, organizing, and political lobbying. */
export declare type WorkersUnion = WorkersUnionLeaf | string;
export interface WPAdBlockLeaf extends WebPageElementBase {
  "@type": "WPAdBlock";
}
/** An advertising section of the page. */
export declare type WPAdBlock = WPAdBlockLeaf;
export interface WPFooterLeaf extends WebPageElementBase {
  "@type": "WPFooter";
}
/** The footer section of the page. */
export declare type WPFooter = WPFooterLeaf;
export interface WPHeaderLeaf extends WebPageElementBase {
  "@type": "WPHeader";
}
/** The header section of the page. */
export declare type WPHeader = WPHeaderLeaf;
export interface WPSideBarLeaf extends WebPageElementBase {
  "@type": "WPSideBar";
}
/** A sidebar section of the page. */
export declare type WPSideBar = WPSideBarLeaf;
export interface WriteActionBase extends ActionBase {
  /** The language of the content or performance or used in an action. Please use one of the language codes from the {@link http://tools.ietf.org/html/bcp47 IETF BCP 47 standard}. See also {@link https://schema.org/availableLanguage availableLanguage}. */
  "inLanguage"?: SchemaValue<Language | Text | IdReference, "inLanguage">;
  /**
   * A sub property of instrument. The language used on this action.
...
export interface WriteActionLeaf extends WriteActionBase {
  "@type": "WriteAction";
}
...
export interface ZooLeaf extends CivicStructureBase {
  "@type": "Zoo";
}
/** A zoo. */
