...
export const allowCorsFor = (req?: Request): Record<string, string> => allowCorsForOrigin(req?.headers?.get("origin") ?? "*");

export const allowCorsForOrigin = (...origin: string[]): Record<string, string> => ({
